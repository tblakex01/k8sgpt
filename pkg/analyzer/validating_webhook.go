			...
			if err != nil {
				...
				failures = append(failures, common.Failure{
					...
					Remediation: &common.Remediation{
						...
						Description: "The service referenced by the validating webhook does not exist. Webhook calls will fail.",
						Steps: []string{
							fmt.Sprintf("kubectl describe validatingwebhookconfiguration %s", webhookConfig.Name),
