...
## [0.5.0](https://github.com/tblakex01/k8sgpt/compare/v0.4.30...v0.5.0) (2026-03-26)
...
* add analysis-history MCP tool with list, diff, trend actions ([a57107d](https://github.com/tblakex01/k8sgpt/commit/a57107ddf18ac952389c9944be05546a5f44e475))
...
* add health score computation package ([c4e9e7e](https://github.com/tblakex01/k8sgpt/commit/c4e9e7e7d75b3adaa7619a022d70efb2e8b7b091))
* add health score MCP tool, resource, and Prometheus metrics ([1fb49b9](https://github.com/tblakex01/k8sgpt/commit/1fb49b916eb5eda304968ee8837fab94b7eac923))
...
* add k8sgpt history CLI command with list, diff, trend, prune ([8b8d0a4](https://github.com/tblakex01/k8sgpt/commit/8b8d0a498b2839ea57a8d88b50a714547ac7e864))
* add k8sgpt policy CLI command with list, test, audit ([9f57c5d](https://github.com/tblakex01/k8sgpt/commit/9f57c5dab1f2afb9dc91b003b51f71d13c0eb914))
* add k8sgpt score CLI command ([6e3e272](https://github.com/tblakex01/k8sgpt/commit/6e3e27282fa39cf4044f0c30c6e0fe2f6c2d32a5))
...
* add modernc.org/sqlite and oklog/ulid dependencies ([dc0f037](https://github.com/tblakex01/k8sgpt/commit/dc0f0371084429e01e891b07dd63239de020b1fd))
...
* add policy audit log query support ([2196599](https://github.com/tblakex01/k8sgpt/commit/2196599b90fcb5a2724078cfc5bb29ace921e379))
* add policy execution engine with auto, dry-run, and interactive modes ([d0b1b64](https://github.com/tblakex01/k8sgpt/commit/d0b1b6437773ffc979f01c8e7b31f6d084b47622))
* add policy types and matching logic for remediation engine ([5a80345](https://github.com/tblakex01/k8sgpt/commit/5a803459cd6fc61cab3a975ee267903b8def1224))
...
* add remediation-policies and policy-audit MCP tools ([12f56db](https://github.com/tblakex01/k8sgpt/commit/12f56db4e96b3618016286438e5cbe16d06abba0))
...
* add SQLite-backed results store with diff and trend support ([c1f7182](https://github.com/tblakex01/k8sgpt/commit/c1f71827893f918a2031b23b6e2bd5554fe79c41))
...
* add store interface and types for results history ([b9a7696](https://github.com/tblakex01/k8sgpt/commit/b9a76964e7c51c52cd524c817af2b8d5d837739f))
...
* integrate health score into analysis pipeline and output ([e4c0e3d](https://github.com/tblakex01/k8sgpt/commit/e4c0e3d086df72f3cfd1e1b3769f31dd38e57899))
* integrate policy engine into analyze command with fallback to legacy remediation ([22cfc6c](https://github.com/tblakex01/k8sgpt/commit/22cfc6c34489d82f0fb340b3d572829ec8951a19))
* integrate results store into analysis pipeline with auto-persistence ([97bc323](https://github.com/tblakex01/k8sgpt/commit/97bc32372cda45632552f1fb1bda4d5de9c30ce7))
...
* address lint issues in new packages ([84b4ae5](https://github.com/tblakex01/k8sgpt/commit/84b4ae599419e7f49118803cdb36c065109c3f39))
...
* **security:** add kubectl-only guard to executeInteractive ([f3a2234](https://github.com/tblakex01/k8sgpt/commit/f3a22347c9942b9fc5f2886df31fb33e35b222b9))
...
* update CLAUDE.md, fix lints, and refactor tests across codebase ([0d0a02d](https://github.com/tblakex01/k8sgpt/commit/0d0a02d2d7cd708b80f5357cb6620ee119acf146))
...
* simplify new packages — deduplicate store init, add policy constants, cache regex ([b5205f6](https://github.com/tblakex01/k8sgpt/commit/b5205f6b2af7617dfd055a749a84273524006a59))
