...
## [0.5.0](https://github.com/tblakex01/k8sgpt/compare/v0.4.30...v0.5.0) (2026-03-16)


### ⚠ BREAKING CHANGES

* Removal of Trivy ([#1386](https://github.com/tblakex01/k8sgpt/issues/1386))

### Features

* add a naive support of bedrock inference profile ([#1446](https://github.com/tblakex01/k8sgpt/issues/1446)) ([78ffa59](https://github.com/tblakex01/k8sgpt/commit/78ffa5904addf71caf04554966437b14351f21e5))
* add amazon bedrock nova pro and nova lite models ([#1383](https://github.com/tblakex01/k8sgpt/issues/1383)) ([aa1e237](https://github.com/tblakex01/k8sgpt/commit/aa1e237ebb8c816383561c9b3e6a1ca0ddea8f78))
* add APAC region Claude models support for Amazon Bedrock ([#1543](https://github.com/tblakex01/k8sgpt/issues/1543)) ([1819e6f](https://github.com/tblakex01/k8sgpt/commit/1819e6f410d078fce2bda8bbdb22054dfb4fc092))
* add ClusterCatalog and ClusterExtension analyzers ([#1555](https://github.com/tblakex01/k8sgpt/issues/1555)) ([a821814](https://github.com/tblakex01/k8sgpt/commit/a821814125e25c062ff2faebf9df1b880414c22c))
* add ClusterServiceVersion, Subscription, InstallPlan, OperatorGroup, and CatalogSource analyzers ([#1564](https://github.com/tblakex01/k8sgpt/issues/1564)) ([0cf4cae](https://github.com/tblakex01/k8sgpt/commit/0cf4cae07e32a0025246abcf2d1a5a91f82d093a))
* add custom http headers to openai related api backends ([#1174](https://github.com/tblakex01/k8sgpt/issues/1174)) ([02e754e](https://github.com/tblakex01/k8sgpt/commit/02e754ed591742fccc5ff9a20c3e36e4475f6ec5))
* add custom restful backend for complex scenarios (e.g, rag) ([#1228](https://github.com/tblakex01/k8sgpt/issues/1228)) ([7540e00](https://github.com/tblakex01/k8sgpt/commit/7540e0084e0c0c44fc52ed9a906b76f9f2e6a981))
* add custom-analyzer cmd ([#1207](https://github.com/tblakex01/k8sgpt/issues/1207)) ([db26d24](https://github.com/tblakex01/k8sgpt/commit/db26d24ac607534ce78c1c82f3e1d4e5dde17578))
* add DaemonSet and Secret analyzers with severity and remediation ([#2](https://github.com/tblakex01/k8sgpt/issues/2)) ([d8b893a](https://github.com/tblakex01/k8sgpt/commit/d8b893afe13aa8f7070dd4a61e5f16c86e0756b9))
* add event failure handling in service analyzer ([#1132](https://github.com/tblakex01/k8sgpt/issues/1132)) ([a4e44d5](https://github.com/tblakex01/k8sgpt/commit/a4e44d59e3ee63714cfd144228299e4f24ac3691))
* add Google Vertex AI as provider to utilize gemini via GCP ([#984](https://github.com/tblakex01/k8sgpt/issues/984)) ([55ac0b2](https://github.com/tblakex01/k8sgpt/commit/55ac0b2129a438661a0253251f546db6b59f2b92))
* add Groq as LLM provider ([#1600](https://github.com/tblakex01/k8sgpt/issues/1600)) ([867bce1](https://github.com/tblakex01/k8sgpt/commit/867bce1907f5dd3387128b72c694e98091d55554))
* add huggingface provider ([#893](https://github.com/tblakex01/k8sgpt/issues/893)) ([2fd476e](https://github.com/tblakex01/k8sgpt/commit/2fd476e12624e30570c0819594f2668f720381d6))
* add keda integration ([#1058](https://github.com/tblakex01/k8sgpt/issues/1058)) ([9a73d19](https://github.com/tblakex01/k8sgpt/commit/9a73d1923f146aa1343465d89225e64bcb8e0112))
* add label selector ([#1201](https://github.com/tblakex01/k8sgpt/issues/1201)) ([eb3b81f](https://github.com/tblakex01/k8sgpt/commit/eb3b81f1767c589474864992ae78001ab1b376a1))
* add latest and legacy stable models ([#1539](https://github.com/tblakex01/k8sgpt/issues/1539)) ([00c0799](https://github.com/tblakex01/k8sgpt/commit/00c07999e2290e70a6ecb95b255b4924f55ecd5f))
* add MCP support ([#1471](https://github.com/tblakex01/k8sgpt/issues/1471)) ([e41ffd8](https://github.com/tblakex01/k8sgpt/commit/e41ffd80d01ce7ae1fac9ce7e07344020d8bf914))
* add minio support ([#1048](https://github.com/tblakex01/k8sgpt/issues/1048)) ([e6085d4](https://github.com/tblakex01/k8sgpt/commit/e6085d4191a1695e295f4f6a2ac7219b67a37225))
* add new AWS Bedrock model ids ([#1330](https://github.com/tblakex01/k8sgpt/issues/1330)) ([a12aa07](https://github.com/tblakex01/k8sgpt/commit/a12aa07b1a2e34c5106b7b930b29b0c97b172dc4))
* add Ollama backend ([#1065](https://github.com/tblakex01/k8sgpt/issues/1065)) ([b35dbd9](https://github.com/tblakex01/k8sgpt/commit/b35dbd9b09197994f041cda04f1a4e5fb316e468))
* add proxysettings for azureopenai and openai ([#987](https://github.com/tblakex01/k8sgpt/issues/987)) ([307710e](https://github.com/tblakex01/k8sgpt/commit/307710eddc1c3f96f40a674f7dda786510e9c4cc))
* add Resource Kind in output ([#1069](https://github.com/tblakex01/k8sgpt/issues/1069)) ([aa276a5](https://github.com/tblakex01/k8sgpt/commit/aa276a5379b3d24a8e7a1f8b1193832df5a46220))
* add spec.template.spec.securityContext  ([#1109](https://github.com/tblakex01/k8sgpt/issues/1109)) ([92dd1bd](https://github.com/tblakex01/k8sgpt/commit/92dd1bd8b08c5173f72a6c333f626c63aa05a1d3))
* add stats option to analyze command for performance insights ([#1237](https://github.com/tblakex01/k8sgpt/issues/1237)) ([3eec9bb](https://github.com/tblakex01/k8sgpt/commit/3eec9bbb05b2f0717437cc4a2ec786594ece1cc3))
* add streamable-http support for MCP server ([#1546](https://github.com/tblakex01/k8sgpt/issues/1546)) ([3a1187a](https://github.com/tblakex01/k8sgpt/commit/3a1187ad5a190713b9216cf6d9d52d54cdb3e4da))
* add support for Amazon Bedrock Inference Profiles ([#1492](https://github.com/tblakex01/k8sgpt/issues/1492)) ([21bc76e](https://github.com/tblakex01/k8sgpt/commit/21bc76e5b77524b48f09ef6707204742dcd879a7))
* add verbose flag to enable detailed output ([#1420](https://github.com/tblakex01/k8sgpt/issues/1420)) ([a79224e](https://github.com/tblakex01/k8sgpt/commit/a79224e2bf96f458dbc96404c8f4847970e8d2ef))
* add watsonx ai provider ([#1163](https://github.com/tblakex01/k8sgpt/issues/1163)) ([ce63821](https://github.com/tblakex01/k8sgpt/commit/ce63821bebbd87b2e058f5cf58a2cdd474b8fb58))
* added cache purge ([#1532](https://github.com/tblakex01/k8sgpt/issues/1532)) ([74fbde0](https://github.com/tblakex01/k8sgpt/commit/74fbde00537e627c408b317ff9098227be11e2ad))
* added FailedMount event reason to get the failure ([#883](https://github.com/tblakex01/k8sgpt/issues/883)) ([78126b2](https://github.com/tblakex01/k8sgpt/commit/78126b2328c1b3f81a269d203e86128104050010))
* added Google GenAI client; simplified IAI/clients API surface. ([#829](https://github.com/tblakex01/k8sgpt/issues/829)) ([e7d4149](https://github.com/tblakex01/k8sgpt/commit/e7d41496ddaa145c70079852da8b2ce3b3b7289f))
* added support for A21 and Amazon Titan models via bedrock api ([#1101](https://github.com/tblakex01/k8sgpt/issues/1101)) ([4f3ecf0](https://github.com/tblakex01/k8sgpt/commit/4f3ecf008351075068738e930ff3a657f597654a))
* added token for goreleaser ([#1476](https://github.com/tblakex01/k8sgpt/issues/1476)) ([85935a4](https://github.com/tblakex01/k8sgpt/commit/85935a46d8f137b0339435cf19ce7f83ead97f8c))
* adding a query mode for the schednex scheduler ([#1257](https://github.com/tblakex01/k8sgpt/issues/1257)) ([53465d5](https://github.com/tblakex01/k8sgpt/commit/53465d5c832ac490403a2698b80122ca06372df7))
* adding fixes for Messages API issue 1391 ([#1504](https://github.com/tblakex01/k8sgpt/issues/1504)) ([b2241c0](https://github.com/tblakex01/k8sgpt/commit/b2241c03c975aeab02897d73e57cd351f60f3af3))
* adds interplex as a caching provider ([#1328](https://github.com/tblakex01/k8sgpt/issues/1328)) ([d6d80ee](https://github.com/tblakex01/k8sgpt/commit/d6d80ee86083643d9b91457791bfc77ef475e82e))
* aws integration ([#967](https://github.com/tblakex01/k8sgpt/issues/967)) ([a81377f](https://github.com/tblakex01/k8sgpt/commit/a81377f72db7f322e0afbb6d613c2bfffecf8080))
* bump golang version to 1.22 ([#1117](https://github.com/tblakex01/k8sgpt/issues/1117)) ([6652fbe](https://github.com/tblakex01/k8sgpt/commit/6652fbe7cb6e581497e1d086e13397ff9e5b11be))
* call bedrock with inference profile ([#1449](https://github.com/tblakex01/k8sgpt/issues/1449)) ([91d423b](https://github.com/tblakex01/k8sgpt/commit/91d423b147ca18cda7d54ff19349938a894ecb85))
* codecov ([#1023](https://github.com/tblakex01/k8sgpt/issues/1023)) ([fe81d16](https://github.com/tblakex01/k8sgpt/commit/fe81d16f756e5ea9db909e42e6caf1e17e040f86))
* custom analysis paralelism ([#1203](https://github.com/tblakex01/k8sgpt/issues/1203)) ([f1b7b37](https://github.com/tblakex01/k8sgpt/commit/f1b7b37fb83937d5fad90d7b6b52f4a38823da9e))
* dump ([#1322](https://github.com/tblakex01/k8sgpt/issues/1322)) ([da266b3](https://github.com/tblakex01/k8sgpt/commit/da266b3c82ca8b3e96461be688a9f30e408568fe))
* enable Rest api using grpc-gateway ([#834](https://github.com/tblakex01/k8sgpt/issues/834)) ([f2138c7](https://github.com/tblakex01/k8sgpt/commit/f2138c71017b391625eebdfb4c5708c824824f69))
* enables remote custom analyzers ([#906](https://github.com/tblakex01/k8sgpt/issues/906)) ([c8c9dbf](https://github.com/tblakex01/k8sgpt/commit/c8c9dbfadc72a193ab9f3431d02d50ac5ab5d071))
* enhancement of deployment analyzer ([#1406](https://github.com/tblakex01/k8sgpt/issues/1406)) ([61b60d5](https://github.com/tblakex01/k8sgpt/commit/61b60d5768b54f98232dcc415e89aa38987dc6e3))
* error from events for STS analyzer ([#1256](https://github.com/tblakex01/k8sgpt/issues/1256)) ([d8fad95](https://github.com/tblakex01/k8sgpt/commit/d8fad956f45a4dd668647379bb0295e169faeac6))
* fix the custom-analysis printing ([#1195](https://github.com/tblakex01/k8sgpt/issues/1195)) ([b6dd2a1](https://github.com/tblakex01/k8sgpt/commit/b6dd2a1181b478a4fb8543ab7529ce595fa7d4a8))
* fix to broken inference ([#1575](https://github.com/tblakex01/k8sgpt/issues/1575)) ([291e42d](https://github.com/tblakex01/k8sgpt/commit/291e42dc4b81ffb0672c21fbb325ddebc5d531a3))
* fixed haiku ([#1530](https://github.com/tblakex01/k8sgpt/issues/1530)) ([5636515](https://github.com/tblakex01/k8sgpt/commit/5636515db98b529689a214af5066d50b5e42d3a1))
* fixed missing cache params ([#1340](https://github.com/tblakex01/k8sgpt/issues/1340)) ([1363219](https://github.com/tblakex01/k8sgpt/commit/1363219b1b94e157ef03c53eba8838b7cef559b4))
* free disk ([#1313](https://github.com/tblakex01/k8sgpt/issues/1313)) ([783cd1c](https://github.com/tblakex01/k8sgpt/commit/783cd1cfc66f8e4489e5006529745d8caf38cfd4))
* getting the error from status field for HPA analyzer ([#1164](https://github.com/tblakex01/k8sgpt/issues/1164)) ([a068310](https://github.com/tblakex01/k8sgpt/commit/a068310731d775beecede03a1709e541ffd68142))
* implement Top-K sampling for improved user control ([#1110](https://github.com/tblakex01/k8sgpt/issues/1110)) ([eda5231](https://github.com/tblakex01/k8sgpt/commit/eda52312aef8113debbd770b8354c3a3cb1cc681))
* improved test coverage ([#1455](https://github.com/tblakex01/k8sgpt/issues/1455)) ([80904e3](https://github.com/tblakex01/k8sgpt/commit/80904e3063b00b0536171b7b62b938938b20825a))
* initial custom analysis server mode ([#1205](https://github.com/tblakex01/k8sgpt/issues/1205)) ([16d57e5](https://github.com/tblakex01/k8sgpt/commit/16d57e5a55c2084bf1580377ae52e2961cc84922))
* initial kyverno support ([#1200](https://github.com/tblakex01/k8sgpt/issues/1200)) ([5176759](https://github.com/tblakex01/k8sgpt/commit/5176759bd0fad8671164f9e75b31dec19f02bd54))
* initial Prometheus analyzers ([#855](https://github.com/tblakex01/k8sgpt/issues/855)) ([45fa827](https://github.com/tblakex01/k8sgpt/commit/45fa827c046b91d901a08bec1a892d9c0917f350))
* interactive mode ([#854](https://github.com/tblakex01/k8sgpt/issues/854)) ([9da75e0](https://github.com/tblakex01/k8sgpt/commit/9da75e02bc17146898377e4f90b7f59c5a8e0eee))
* mcp v2 ([#1589](https://github.com/tblakex01/k8sgpt/issues/1589)) ([5480051](https://github.com/tblakex01/k8sgpt/commit/5480051230ce83b89c0382abd7992c7ecc4a85b8))
* multiple security fixes. Prometheus: v0.302.1 → v0.306.0 ([#1597](https://github.com/tblakex01/k8sgpt/issues/1597)) ([f5fb2a7](https://github.com/tblakex01/k8sgpt/commit/f5fb2a7e12e14fad8107940aeead5e60b064add1))
* new analyzers ([#1459](https://github.com/tblakex01/k8sgpt/issues/1459)) ([a128906](https://github.com/tblakex01/k8sgpt/commit/a128906136431189812d4d2dea68ea98cbfe5eeb))
* new job analyzer ([#1506](https://github.com/tblakex01/k8sgpt/issues/1506)) ([0b7ddf5](https://github.com/tblakex01/k8sgpt/commit/0b7ddf5e3b93e56ea92dfb6447e97c067cad9e54))
* oci genai ([#1102](https://github.com/tblakex01/k8sgpt/issues/1102)) ([047afd4](https://github.com/tblakex01/k8sgpt/commit/047afd46d62d1bd1da1435550cbaf9daaca53aee))
* oci genai chat models ([#1337](https://github.com/tblakex01/k8sgpt/issues/1337)) ([290a4be](https://github.com/tblakex01/k8sgpt/commit/290a4be210fbb508214070c31218138781d96142))
* old sonnet ([#1408](https://github.com/tblakex01/k8sgpt/issues/1408)) ([e5817f9](https://github.com/tblakex01/k8sgpt/commit/e5817f9e557f4f97b016a0a7b7674342c3a1773e))
* refactoring to the new schema ([#1219](https://github.com/tblakex01/k8sgpt/issues/1219)) ([02fa109](https://github.com/tblakex01/k8sgpt/commit/02fa109429d3c684079f5d488e7f517806fc1a09))
* reintroduced inference code ([#1548](https://github.com/tblakex01/k8sgpt/issues/1548)) ([7e33276](https://github.com/tblakex01/k8sgpt/commit/7e332761d89d953989b4f33509208dd4db4d4b91))
* Removal of Trivy ([#1386](https://github.com/tblakex01/k8sgpt/issues/1386)) ([d1b2227](https://github.com/tblakex01/k8sgpt/commit/d1b2227ff9a8ef42bf63c83e289fbd801706821e))
* reverting the cncf runners ([#1319](https://github.com/tblakex01/k8sgpt/issues/1319)) ([ad86e7a](https://github.com/tblakex01/k8sgpt/commit/ad86e7aa39995c492437627dbd9f89f152f11f2c))
* rework to how bedrock data models are structured and accessed ([#1369](https://github.com/tblakex01/k8sgpt/issues/1369)) ([7dadea2](https://github.com/tblakex01/k8sgpt/commit/7dadea257007df64148f1e47f7960d1d30df67b2))
* **serve:** add short flag and env var for metrics port ([#1616](https://github.com/tblakex01/k8sgpt/issues/1616)) ([4f63e97](https://github.com/tblakex01/k8sgpt/commit/4f63e9737c6a2306686bd3b6f37e81f210665949))
* skip k3s node type EtcdIsVoter ([#1167](https://github.com/tblakex01/k8sgpt/issues/1167)) ([4366ad9](https://github.com/tblakex01/k8sgpt/commit/4366ad97b80d2df0400e06e4b892fadab3939dc7))
* slack announce ([#1466](https://github.com/tblakex01/k8sgpt/issues/1466)) ([3b6ad06](https://github.com/tblakex01/k8sgpt/commit/3b6ad06de1121c870fb486e0fe2bd1f87be16627))
* support AWS_PROFILE ([#1114](https://github.com/tblakex01/k8sgpt/issues/1114)) ([882c6f5](https://github.com/tblakex01/k8sgpt/commit/882c6f52252000da436e4fed9fd184b263f5a017))
* support for claude4 && model names listed ([#1540](https://github.com/tblakex01/k8sgpt/issues/1540)) ([8002d94](https://github.com/tblakex01/k8sgpt/commit/8002d943453aac8c3675d7072b25dfdc3aec1c1d))
* support openai organization Id ([#1133](https://github.com/tblakex01/k8sgpt/issues/1133)) ([4867d39](https://github.com/tblakex01/k8sgpt/commit/4867d39c66a6c16906cd769a2055dea9f66f1ccb))
* supported regions govcloud ([#1483](https://github.com/tblakex01/k8sgpt/issues/1483)) ([752a16c](https://github.com/tblakex01/k8sgpt/commit/752a16c40728f42f10ab6c3177cb7e24f44db339))
* switching to higher spec runners ([#1312](https://github.com/tblakex01/k8sgpt/issues/1312)) ([5f7d9de](https://github.com/tblakex01/k8sgpt/commit/5f7d9de46a521463cedc901b729fe27f8d86f381))
* test revert runner on release job ([#1310](https://github.com/tblakex01/k8sgpt/issues/1310)) ([cc9b3ea](https://github.com/tblakex01/k8sgpt/commit/cc9b3ea6579c6190629e0fac48e37e0eba650158))
* testupdate ([#1315](https://github.com/tblakex01/k8sgpt/issues/1315)) ([7dcdfc8](https://github.com/tblakex01/k8sgpt/commit/7dcdfc83d2461e4342ded5fa80493936b70f64a1))
* unify aiClientName const for all providers ([#848](https://github.com/tblakex01/k8sgpt/issues/848)) ([5c17c24](https://github.com/tblakex01/k8sgpt/commit/5c17c240550609d9fb7771fe67fe1ab19660b4da))
* update helm charts with mcp support and fix Google ADA issue  ([#1568](https://github.com/tblakex01/k8sgpt/issues/1568)) ([5334589](https://github.com/tblakex01/k8sgpt/commit/53345895deec4c74cac00ee3fd5e230f6a92cf4a))
* updated runners to enterprise ([#1318](https://github.com/tblakex01/k8sgpt/issues/1318)) ([1ae70e8](https://github.com/tblakex01/k8sgpt/commit/1ae70e806e2609c8fb964f0a577304d07b365cae))
* using modelName will calling completion ([#1469](https://github.com/tblakex01/k8sgpt/issues/1469)) ([f603948](https://github.com/tblakex01/k8sgpt/commit/f603948935f1c4cb171378634714577205de7b08))


### Bug Fixes

* [Bug] Filter PolicyReport ignores namespace flag ([#1355](https://github.com/tblakex01/k8sgpt/issues/1355)) ([9dcb21e](https://github.com/tblakex01/k8sgpt/commit/9dcb21e160233eb120ccf50f9b9b80c145d0e01a))
* [Bug] Make lint command is not working ([#1282](https://github.com/tblakex01/k8sgpt/issues/1282)) ([87565a0](https://github.com/tblakex01/k8sgpt/commit/87565a0bcce7087114798c3a32877894c8a9dcee))
* add default maxToken value of watsonxai backend ([#1209](https://github.com/tblakex01/k8sgpt/issues/1209)) ([d43fd87](https://github.com/tblakex01/k8sgpt/commit/d43fd878ba04fec8ac8afe4a1c15272b7f21c951))
* add maxTokens to serve mode ([#1280](https://github.com/tblakex01/k8sgpt/issues/1280)) ([a50375c](https://github.com/tblakex01/k8sgpt/commit/a50375c9605a87546a0fcbcacabe5482fdfa1c2c))
* add providerId to serve mode ([#1260](https://github.com/tblakex01/k8sgpt/issues/1260)) ([da0764d](https://github.com/tblakex01/k8sgpt/commit/da0764d951ca76cb7007c412f8efa794619c20ba))
* advisory k8sgpt ghsa 85rg 8m6h 825p ([#1139](https://github.com/tblakex01/k8sgpt/issues/1139)) ([728555c](https://github.com/tblakex01/k8sgpt/commit/728555c0effbf7a56221d625bcbbf62f74d14359))
* align CI Go versions with go.mod to ensure consistency ([#1611](https://github.com/tblakex01/k8sgpt/issues/1611)) ([1f2ff98](https://github.com/tblakex01/k8sgpt/commit/1f2ff988342b8ef2aa3e3263eb845c0ee09fe24c))
* align documentation to reflect default analyzers properly ([#1498](https://github.com/tblakex01/k8sgpt/issues/1498)) ([7e375a3](https://github.com/tblakex01/k8sgpt/commit/7e375a30bee24198f9221e4a4aea17fcd2fe005c))
* analyze command default backend bug ([#966](https://github.com/tblakex01/k8sgpt/issues/966)) ([aab8d77](https://github.com/tblakex01/k8sgpt/commit/aab8d77febdd4b42ff74aafbb2ada27745c04ae1))
* auth update throw out exception ([#1193](https://github.com/tblakex01/k8sgpt/issues/1193)) ([391a3cd](https://github.com/tblakex01/k8sgpt/commit/391a3cd5adcbd90f37922332b4fad5ba5d813e5f))
* config ai provider in query ([#1457](https://github.com/tblakex01/k8sgpt/issues/1457)) ([df17e3e](https://github.com/tblakex01/k8sgpt/commit/df17e3e728591e974703527dff86de882af17790))
* **deps:** typo in prometheus.go ([fad00ea](https://github.com/tblakex01/k8sgpt/commit/fad00eac4925351c4dc6fd6dd347fe2968f0b7a5))
* **deps:** typo in prometheus.go ([#1137](https://github.com/tblakex01/k8sgpt/issues/1137)) ([fad00ea](https://github.com/tblakex01/k8sgpt/commit/fad00eac4925351c4dc6fd6dd347fe2968f0b7a5))
* **deps:** update all non-major dependencies ([#1291](https://github.com/tblakex01/k8sgpt/issues/1291)) ([14e0f19](https://github.com/tblakex01/k8sgpt/commit/14e0f19b12189052b03d551e409b407fd0b6bd30))
* **deps:** update all non-major dependencies ([#1306](https://github.com/tblakex01/k8sgpt/issues/1306)) ([a6b19a8](https://github.com/tblakex01/k8sgpt/commit/a6b19a81b01e4b9168fa585628eb8c5c35b54537))
* **deps:** update all non-major dependencies ([#1307](https://github.com/tblakex01/k8sgpt/issues/1307)) ([004d9ef](https://github.com/tblakex01/k8sgpt/commit/004d9efc55bcdf822bed947e5273e35c26435e76))
* **deps:** update all non-major dependencies ([#1323](https://github.com/tblakex01/k8sgpt/issues/1323)) ([b3f60b2](https://github.com/tblakex01/k8sgpt/commit/b3f60b2d2018d4bede3918adcb3547ef2acf6688))
* **deps:** update all non-major dependencies ([#1335](https://github.com/tblakex01/k8sgpt/issues/1335)) ([8cd3b29](https://github.com/tblakex01/k8sgpt/commit/8cd3b2985e4cd61711497fb0436e72b6b8aa3162))
* **deps:** update default model to gpt-4o for improved performance and cost efficiency ([#1332](https://github.com/tblakex01/k8sgpt/issues/1332)) ([4e39cb6](https://github.com/tblakex01/k8sgpt/commit/4e39cb65b3a7fc0d1c057c647794346e072d3fd0))
* **deps:** update k8s.io/utils digest to 0849a56 ([#1080](https://github.com/tblakex01/k8sgpt/issues/1080)) ([e894e77](https://github.com/tblakex01/k8sgpt/commit/e894e778e91d070448cd4a3f46dfc98dd588c9ed))
* **deps:** update k8s.io/utils digest to 0f33e8f ([#1484](https://github.com/tblakex01/k8sgpt/issues/1484)) ([6a81d2c](https://github.com/tblakex01/k8sgpt/commit/6a81d2c140f00a405b651d6c6dae5e343ffddb4f))
* **deps:** update k8s.io/utils digest to 18e509b ([#1183](https://github.com/tblakex01/k8sgpt/issues/1183)) ([0b90651](https://github.com/tblakex01/k8sgpt/commit/0b906511d5a9837c9a67cf819754c610b1becc5c))
* **deps:** update k8s.io/utils digest to 1f6e0b7 ([#1405](https://github.com/tblakex01/k8sgpt/issues/1405)) ([f5eaf81](https://github.com/tblakex01/k8sgpt/commit/f5eaf817f0cf2b732013e67e94c758a225c35ba6))
* **deps:** update k8s.io/utils digest to 24370be ([#1344](https://github.com/tblakex01/k8sgpt/issues/1344)) ([fcc8563](https://github.com/tblakex01/k8sgpt/commit/fcc8563e4eba9bf45d49901b7287d311b93372c2))
* **deps:** update k8s.io/utils digest to 4693a02 ([#1037](https://github.com/tblakex01/k8sgpt/issues/1037)) ([94cdce4](https://github.com/tblakex01/k8sgpt/commit/94cdce44b49e0bb85e8b541688b2206e7c1dc33d))
* **deps:** update k8s.io/utils digest to 49e7df5 ([#1259](https://github.com/tblakex01/k8sgpt/issues/1259)) ([7785dd1](https://github.com/tblakex01/k8sgpt/commit/7785dd12a0245a33af25dedd2fbb5f4178b5cda9))
* **deps:** update k8s.io/utils digest to 4c0f3b2 ([#1523](https://github.com/tblakex01/k8sgpt/issues/1523)) ([7d4cb26](https://github.com/tblakex01/k8sgpt/commit/7d4cb267130f60088350213482795f37594cb0bc))
* **deps:** update k8s.io/utils digest to 6fe5fd8 ([#1302](https://github.com/tblakex01/k8sgpt/issues/1302)) ([2f62c7b](https://github.com/tblakex01/k8sgpt/commit/2f62c7b3e0a55bc4749c3382d0fba2f320cc9e0a))
* **deps:** update k8s.io/utils digest to 702e33f ([#1246](https://github.com/tblakex01/k8sgpt/issues/1246)) ([d30563d](https://github.com/tblakex01/k8sgpt/commit/d30563d8cdedb5bbf48735e49ebcb44440a5f0f5))
* **deps:** update k8s.io/utils digest to b8788ab ([#1572](https://github.com/tblakex01/k8sgpt/issues/1572)) ([a56e478](https://github.com/tblakex01/k8sgpt/commit/a56e4788c3361a64df17175f163f33422a8fe606))
* **deps:** update k8s.io/utils digest to e7106e6 ([#897](https://github.com/tblakex01/k8sgpt/issues/897)) ([28c4c57](https://github.com/tblakex01/k8sgpt/commit/28c4c57e4566b9b888a5633090ccb70875d30106))
* **deps:** update module buf.build/gen/go/k8sgpt-ai/k8sgpt/grpc-ecosystem/gateway/v2 to v2.19.1-20240406062209-1cc152efbf5c.1 ([#1070](https://github.com/tblakex01/k8sgpt/issues/1070)) ([24cff90](https://github.com/tblakex01/k8sgpt/commit/24cff90a0ca7488e48c94d13678529617c749aab))
* **deps:** update module buf.build/gen/go/k8sgpt-ai/k8sgpt/grpc-ecosystem/gateway/v2 to v2.20.0-20240406062209-1cc152efbf5c.1 ([#1147](https://github.com/tblakex01/k8sgpt/issues/1147)) ([314f25a](https://github.com/tblakex01/k8sgpt/commit/314f25ac8bf5c3629474ece0eae6a3bda83099aa))
* **deps:** update module buf.build/gen/go/k8sgpt-ai/k8sgpt/grpc-ecosystem/gateway/v2 to v2.22.0-20240807134501-ea98c104104d.1 ([#1186](https://github.com/tblakex01/k8sgpt/issues/1186)) ([8405778](https://github.com/tblakex01/k8sgpt/commit/8405778cb25429d2b42d7a3b50ec88b45961a57f))
* **deps:** update module buf.build/gen/go/k8sgpt-ai/k8sgpt/grpc/go to v1.3.0-20240128172516-6bf6a55ff115.2 ([#899](https://github.com/tblakex01/k8sgpt/issues/899)) ([e3eee6d](https://github.com/tblakex01/k8sgpt/commit/e3eee6d9566a59fd62e6bb804257b1383f75e3ef))
* **deps:** update module buf.build/gen/go/k8sgpt-ai/k8sgpt/grpc/go to v1.3.0-20240406062209-1cc152efbf5c.3 ([#1086](https://github.com/tblakex01/k8sgpt/issues/1086)) ([820cd2e](https://github.com/tblakex01/k8sgpt/commit/820cd2e16cbca2c89b56a4d2a69f95f3f5cd6c6b))
* **deps:** update module buf.build/gen/go/k8sgpt-ai/k8sgpt/grpc/go to v1.4.0-20240715142657-3785f0a44aae.2 ([#1196](https://github.com/tblakex01/k8sgpt/issues/1196)) ([f9edbf3](https://github.com/tblakex01/k8sgpt/commit/f9edbf34f3eb3e90528d04b1c470fd6ef15293ec))
* **deps:** update module buf.build/gen/go/k8sgpt-ai/k8sgpt/protocolbuffers/go to v1.35.1-20240920204244-7a91c8620515.1 ([#1274](https://github.com/tblakex01/k8sgpt/issues/1274)) ([9f39abf](https://github.com/tblakex01/k8sgpt/commit/9f39abf89e4e92009f5e138d9b01d11c60ac135c))
* **deps:** update module cloud.google.com/go/storage to v1.37.0 ([#934](https://github.com/tblakex01/k8sgpt/issues/934)) ([3d2554b](https://github.com/tblakex01/k8sgpt/commit/3d2554b9cd8817b24cf8858a107420d6d8424aa4))
* **deps:** update module cloud.google.com/go/storage to v1.38.0 ([#950](https://github.com/tblakex01/k8sgpt/issues/950)) ([6207c70](https://github.com/tblakex01/k8sgpt/commit/6207c70c51d2885c4590c255c8f78e7ee2009034))
* **deps:** update module cloud.google.com/go/storage to v1.39.1 ([#1029](https://github.com/tblakex01/k8sgpt/issues/1029)) ([a3896f4](https://github.com/tblakex01/k8sgpt/commit/a3896f4518ec6666a43de22a24a18f2b93c58073))
* **deps:** update module cloud.google.com/go/storage to v1.40.0 ([#1054](https://github.com/tblakex01/k8sgpt/issues/1054)) ([6df0169](https://github.com/tblakex01/k8sgpt/commit/6df01694916504cc4af3795361a4285098e2de85))
* **deps:** update module cloud.google.com/go/storage to v1.43.0 ([#1198](https://github.com/tblakex01/k8sgpt/issues/1198)) ([8949f5b](https://github.com/tblakex01/k8sgpt/commit/8949f5bac3c69130e30103511fdb5ece66e1619f))
* **deps:** update module cloud.google.com/go/storage to v1.44.0 ([#1265](https://github.com/tblakex01/k8sgpt/issues/1265)) ([4143e9f](https://github.com/tblakex01/k8sgpt/commit/4143e9fd524bed3179524d949b7b0f92c02ecd11))
* **deps:** update module github.com/adrg/xdg to v0.5.0 ([#1262](https://github.com/tblakex01/k8sgpt/issues/1262)) ([98237b6](https://github.com/tblakex01/k8sgpt/commit/98237b6408521ee7afc05fcaed2f78ba79e77144))
* **deps:** update module github.com/aquasecurity/trivy-operator to v0.22.0 ([#1034](https://github.com/tblakex01/k8sgpt/issues/1034)) ([037e745](https://github.com/tblakex01/k8sgpt/commit/037e745c6f667830f0e1d531ce4bbd07083ef972))
* **deps:** update module github.com/aws/aws-sdk-go to v1.49.15 ([#835](https://github.com/tblakex01/k8sgpt/issues/835)) ([e78ff05](https://github.com/tblakex01/k8sgpt/commit/e78ff054190cd54cabe17d77ac69443e517f1e55))
* **deps:** update module github.com/aws/aws-sdk-go to v1.49.16 ([#847](https://github.com/tblakex01/k8sgpt/issues/847)) ([ce4910b](https://github.com/tblakex01/k8sgpt/commit/ce4910bc5d064f80076877d7a096fff903308b63))
* **deps:** update module github.com/aws/aws-sdk-go to v1.49.17 ([#852](https://github.com/tblakex01/k8sgpt/issues/852)) ([85ebd12](https://github.com/tblakex01/k8sgpt/commit/85ebd12c30d369c5ef9a42b5a834d091523a7b6e))
* **deps:** update module github.com/aws/aws-sdk-go to v1.49.18 ([#856](https://github.com/tblakex01/k8sgpt/issues/856)) ([4106d39](https://github.com/tblakex01/k8sgpt/commit/4106d39c322940413ebfd9ac0bf6f5bd31830e93))
* **deps:** update module github.com/aws/aws-sdk-go to v1.49.19 ([#859](https://github.com/tblakex01/k8sgpt/issues/859)) ([6a2f315](https://github.com/tblakex01/k8sgpt/commit/6a2f315b2f4344f2924b7915e8a1393f9732a1e9))
* **deps:** update module github.com/aws/aws-sdk-go to v1.49.21 ([#868](https://github.com/tblakex01/k8sgpt/issues/868)) ([88002e7](https://github.com/tblakex01/k8sgpt/commit/88002e7e8c3e9c71365c44e136a6f1a8d35e1744))
* **deps:** update module github.com/aws/aws-sdk-go to v1.50.2 ([#887](https://github.com/tblakex01/k8sgpt/issues/887)) ([817d9cf](https://github.com/tblakex01/k8sgpt/commit/817d9cf754d307d374befc0d57919eb7a0183aaf))
* **deps:** update module github.com/aws/aws-sdk-go to v1.50.20 ([#930](https://github.com/tblakex01/k8sgpt/issues/930)) ([3f0356b](https://github.com/tblakex01/k8sgpt/commit/3f0356be662c32d82ce4f3db05f859477823717d))
* **deps:** update module github.com/aws/aws-sdk-go to v1.50.21 ([#970](https://github.com/tblakex01/k8sgpt/issues/970)) ([00c91f0](https://github.com/tblakex01/k8sgpt/commit/00c91f05a62b2c8b2d756b58b95279195ff38d3d))
* **deps:** update module github.com/aws/aws-sdk-go to v1.50.22 ([#971](https://github.com/tblakex01/k8sgpt/issues/971)) ([6ac815c](https://github.com/tblakex01/k8sgpt/commit/6ac815c10fb073f4251e338ab22e247625f21406))
* **deps:** update module github.com/aws/aws-sdk-go to v1.50.34 ([#974](https://github.com/tblakex01/k8sgpt/issues/974)) ([425f33b](https://github.com/tblakex01/k8sgpt/commit/425f33bb2ddf8cdaff079b097d6956f675c89b0e))
* **deps:** update module github.com/aws/aws-sdk-go to v1.51.14 ([#1051](https://github.com/tblakex01/k8sgpt/issues/1051)) ([007b4bb](https://github.com/tblakex01/k8sgpt/commit/007b4bb8ec4b36705f76fd2f5d96464c75915573))
* **deps:** update module github.com/aws/aws-sdk-go to v1.51.21 ([#1056](https://github.com/tblakex01/k8sgpt/issues/1056)) ([ccb692c](https://github.com/tblakex01/k8sgpt/commit/ccb692c1fdc5496d9d5810dfe41dbf1bdeb68d00))
* **deps:** update module github.com/aws/aws-sdk-go to v1.51.32 ([#1083](https://github.com/tblakex01/k8sgpt/issues/1083)) ([75c2add](https://github.com/tblakex01/k8sgpt/commit/75c2addf66a54df57d0c0ac17f0b359f7612e446))
* **deps:** update module github.com/aws/aws-sdk-go to v1.51.8 ([#1046](https://github.com/tblakex01/k8sgpt/issues/1046)) ([19ae31b](https://github.com/tblakex01/k8sgpt/commit/19ae31b5dd5c54413025cee8081d112223e38400))
* **deps:** update module github.com/aws/aws-sdk-go to v1.52.3 ([#1094](https://github.com/tblakex01/k8sgpt/issues/1094)) ([3c48231](https://github.com/tblakex01/k8sgpt/commit/3c4823127ca04d1d280da6d932e951e6c3f71536))
* **deps:** update module github.com/aws/aws-sdk-go to v1.53.21 ([#1106](https://github.com/tblakex01/k8sgpt/issues/1106)) ([bdd470f](https://github.com/tblakex01/k8sgpt/commit/bdd470f9cae917f965badd22da7def4a7d64d2ae))
* **deps:** update module github.com/aws/aws-sdk-go to v1.55.5 ([#1263](https://github.com/tblakex01/k8sgpt/issues/1263)) ([0148a5b](https://github.com/tblakex01/k8sgpt/commit/0148a5b3549cbdb6c6e5832dc01aab044b90ddc9))
* **deps:** update module github.com/azure/azure-sdk-for-go/sdk/azidentity to v1.5.1 ([#939](https://github.com/tblakex01/k8sgpt/issues/939)) ([ce7c955](https://github.com/tblakex01/k8sgpt/commit/ce7c9551bcb1a8b24922a1eb062605bbfeec7929))
* **deps:** update module github.com/azure/azure-sdk-for-go/sdk/azidentity to v1.5.2 ([#1084](https://github.com/tblakex01/k8sgpt/issues/1084)) ([bd695d0](https://github.com/tblakex01/k8sgpt/commit/bd695d0987e8ec12b44512c46bc5f2e5116076bd))
* **deps:** update module github.com/azure/azure-sdk-for-go/sdk/azidentity to v1.6.0 [security] ([#1138](https://github.com/tblakex01/k8sgpt/issues/1138)) ([3a89318](https://github.com/tblakex01/k8sgpt/commit/3a893184af50f8c822ac06ce0e20818eaec587b1))
* **deps:** update module github.com/azure/azure-sdk-for-go/sdk/azidentity to v1.8.0 ([#1264](https://github.com/tblakex01/k8sgpt/issues/1264)) ([3613585](https://github.com/tblakex01/k8sgpt/commit/36135857ac55e126b3a6c4533a000cb0b7f32c6b))
* **deps:** update module github.com/azure/azure-sdk-for-go/sdk/storage/azblob to v1.3.0 ([#952](https://github.com/tblakex01/k8sgpt/issues/952)) ([fea2ed1](https://github.com/tblakex01/k8sgpt/commit/fea2ed1fff5fb5a46d6abc2feb72e1e1adf3b69b))
* **deps:** update module github.com/azure/azure-sdk-for-go/sdk/storage/azblob to v1.3.1 ([#992](https://github.com/tblakex01/k8sgpt/issues/992)) ([85f18dd](https://github.com/tblakex01/k8sgpt/commit/85f18dde1f820fe2413cc6b3109e67b7a010142c))
* **deps:** update module github.com/azure/azure-sdk-for-go/sdk/storage/azblob to v1.3.2 ([#1085](https://github.com/tblakex01/k8sgpt/issues/1085)) ([43953ff](https://github.com/tblakex01/k8sgpt/commit/43953ffa3412ae97b6d54ed14b94955d1b73feba))
* **deps:** update module github.com/azure/azure-sdk-for-go/sdk/storage/azblob to v1.4.1 ([#1275](https://github.com/tblakex01/k8sgpt/issues/1275)) ([c9b11b6](https://github.com/tblakex01/k8sgpt/commit/c9b11b6eee00d0269a4d48ad2e4be5458436b51d))
* **deps:** update module github.com/cohere-ai/cohere-go/v2 to v2.12.0 ([#1276](https://github.com/tblakex01/k8sgpt/issues/1276)) ([7a3fb3c](https://github.com/tblakex01/k8sgpt/commit/7a3fb3cf6777d5b0babf00455c3833a47bb1bfdb))
* **deps:** update module github.com/cohere-ai/cohere-go/v2 to v2.7.3 ([#1087](https://github.com/tblakex01/k8sgpt/issues/1087)) ([36ccc62](https://github.com/tblakex01/k8sgpt/commit/36ccc628462ad102712fca115b56f521b2b33b38))
* **deps:** update module github.com/docker/docker to v27.1.1+incompatible [security] ([#1220](https://github.com/tblakex01/k8sgpt/issues/1220)) ([3148b5c](https://github.com/tblakex01/k8sgpt/commit/3148b5c61d2ff57d67d966d6e915994d4aa8a844))
* **deps:** update module github.com/google/generative-ai-go to v0.10.0 ([#1047](https://github.com/tblakex01/k8sgpt/issues/1047)) ([6b38a56](https://github.com/tblakex01/k8sgpt/commit/6b38a56afbdaa8e0d8f025088a52d3022673ef9d))
* **deps:** update module github.com/google/generative-ai-go to v0.11.0 ([#1089](https://github.com/tblakex01/k8sgpt/issues/1089)) ([f30c9f5](https://github.com/tblakex01/k8sgpt/commit/f30c9f555449bb90bf8242b88b8fae936cb57938))
* **deps:** update module github.com/google/generative-ai-go to v0.18.0 ([#1278](https://github.com/tblakex01/k8sgpt/issues/1278)) ([ad349ae](https://github.com/tblakex01/k8sgpt/commit/ad349ae263f226e300f60dd092729c5a3bf61dbe))
* **deps:** update module github.com/google/generative-ai-go to v0.7.0 ([#940](https://github.com/tblakex01/k8sgpt/issues/940)) ([3c8d9d4](https://github.com/tblakex01/k8sgpt/commit/3c8d9d42e573f27185a1572d1bc06f8af87f3a0b))
* **deps:** update module github.com/google/generative-ai-go to v0.8.0 ([#965](https://github.com/tblakex01/k8sgpt/issues/965)) ([248260e](https://github.com/tblakex01/k8sgpt/commit/248260e081327de9f9d1d2c851efab2b4a3e7ede))
* **deps:** update module github.com/ibm/watsonx-go to v1.0.1 ([#1187](https://github.com/tblakex01/k8sgpt/issues/1187)) ([34b6de3](https://github.com/tblakex01/k8sgpt/commit/34b6de34041ce253c1c680a7f5fe535b03a50da5))
* **deps:** update module github.com/mittwald/go-helm-client to v0.12.10 ([#1177](https://github.com/tblakex01/k8sgpt/issues/1177)) ([fef8539](https://github.com/tblakex01/k8sgpt/commit/fef853966fc6e33dae0a9686fa767b36201c0228))
* **deps:** update module github.com/mittwald/go-helm-client to v0.12.12 ([#1226](https://github.com/tblakex01/k8sgpt/issues/1226)) ([7019d0b](https://github.com/tblakex01/k8sgpt/commit/7019d0b62f1bebbd4c2a251c98a2beb4975bf2fe))
* **deps:** update module github.com/mittwald/go-helm-client to v0.12.13 ([#1251](https://github.com/tblakex01/k8sgpt/issues/1251)) ([1dfd139](https://github.com/tblakex01/k8sgpt/commit/1dfd13973165bd2820aa8ca079e1ec656a5033f0))
* **deps:** update module github.com/prometheus/client_golang to v1.19.0 ([#989](https://github.com/tblakex01/k8sgpt/issues/989)) ([4065fae](https://github.com/tblakex01/k8sgpt/commit/4065faef13691f9cf1f50696c62d3b30b0933b4b))
* **deps:** update module github.com/prometheus/prometheus to v0.53.1 ([#1035](https://github.com/tblakex01/k8sgpt/issues/1035)) ([de9ef85](https://github.com/tblakex01/k8sgpt/commit/de9ef8587822814542661e0039b47ef65d902abb))
* **deps:** update module github.com/prometheus/prometheus to v2 ([#863](https://github.com/tblakex01/k8sgpt/issues/863)) ([a253af2](https://github.com/tblakex01/k8sgpt/commit/a253af23b601b23179be5019fbb832a41423cdae))
* **deps:** update module github.com/pterm/pterm to v0.12.75 ([#881](https://github.com/tblakex01/k8sgpt/issues/881)) ([e7d690a](https://github.com/tblakex01/k8sgpt/commit/e7d690afd12cb71d7b344ba92bf059ae18a993c8))
* **deps:** update module github.com/pterm/pterm to v0.12.78 ([#890](https://github.com/tblakex01/k8sgpt/issues/890)) ([f9c1b90](https://github.com/tblakex01/k8sgpt/commit/f9c1b903385978be56f9c4bc87089bd1c761bbea))
* **deps:** update module github.com/pterm/pterm to v0.12.79 ([#943](https://github.com/tblakex01/k8sgpt/issues/943)) ([bfbb5c7](https://github.com/tblakex01/k8sgpt/commit/bfbb5c7e03cad144f6037c7233ffc0817fd403e4))
* **deps:** update module github.com/sashabaranov/go-openai to v1.17.11 ([#853](https://github.com/tblakex01/k8sgpt/issues/853)) ([1979c86](https://github.com/tblakex01/k8sgpt/commit/1979c86d0f59921d55cd4229a37d604a6f1dc578))
* **deps:** update module github.com/sashabaranov/go-openai to v1.17.11 ([#861](https://github.com/tblakex01/k8sgpt/issues/861)) ([40b5b7e](https://github.com/tblakex01/k8sgpt/commit/40b5b7e185c8d335bdefb131988b9900ad26bac3))
* **deps:** update module github.com/sashabaranov/go-openai to v1.18.1 ([#871](https://github.com/tblakex01/k8sgpt/issues/871)) ([6c62c1a](https://github.com/tblakex01/k8sgpt/commit/6c62c1a0fcd38cf9de8a99cda6f37b221740b9c8))
* **deps:** update module github.com/sashabaranov/go-openai to v1.18.2 ([#874](https://github.com/tblakex01/k8sgpt/issues/874)) ([4de1bbd](https://github.com/tblakex01/k8sgpt/commit/4de1bbd6f72ca83d46ce5955bac50dffc99af03d))
* **deps:** update module github.com/sashabaranov/go-openai to v1.19.2 ([#886](https://github.com/tblakex01/k8sgpt/issues/886)) ([c601972](https://github.com/tblakex01/k8sgpt/commit/c6019728aea837884620e0b4894568802a948a6e))
* **deps:** update module github.com/sashabaranov/go-openai to v1.19.3 ([#937](https://github.com/tblakex01/k8sgpt/issues/937)) ([f2eb1ef](https://github.com/tblakex01/k8sgpt/commit/f2eb1ef5334877fd3a26dda8c92023f831ea857e))
* **deps:** update module github.com/sashabaranov/go-openai to v1.19.4 ([#963](https://github.com/tblakex01/k8sgpt/issues/963)) ([8b0b61e](https://github.com/tblakex01/k8sgpt/commit/8b0b61e596f790b9558a5e3d1f634a5ee1c6cb0c))
* **deps:** update module github.com/sashabaranov/go-openai to v1.20.0 ([#977](https://github.com/tblakex01/k8sgpt/issues/977)) ([e07822c](https://github.com/tblakex01/k8sgpt/commit/e07822c10bff5dbd91f4da592914c25538353d6b))
* **deps:** update module github.com/sashabaranov/go-openai to v1.20.1 ([#986](https://github.com/tblakex01/k8sgpt/issues/986)) ([88a7907](https://github.com/tblakex01/k8sgpt/commit/88a7907db4700c241e9aa109bc3d8604a8186f87))
* **deps:** update module github.com/sashabaranov/go-openai to v1.20.2 ([#991](https://github.com/tblakex01/k8sgpt/issues/991)) ([d2754d3](https://github.com/tblakex01/k8sgpt/commit/d2754d320fb1f285f93fdced2b8469280bd47fd2))
* **deps:** update module github.com/sashabaranov/go-openai to v1.20.4 ([#1039](https://github.com/tblakex01/k8sgpt/issues/1039)) ([6a46a26](https://github.com/tblakex01/k8sgpt/commit/6a46a26789f730d298cf49a706421f36bc8523b1))
* **deps:** update module github.com/sashabaranov/go-openai to v1.23.0 ([#1091](https://github.com/tblakex01/k8sgpt/issues/1091)) ([e74fc08](https://github.com/tblakex01/k8sgpt/commit/e74fc0838feac5a019a340f7c5ad1c9ae49913fa))
* **deps:** update module github.com/schollz/progressbar/v3 to v3.14.2 ([#983](https://github.com/tblakex01/k8sgpt/issues/983)) ([af3732a](https://github.com/tblakex01/k8sgpt/commit/af3732ad067b809c54c5f08f6cf5a7a519b452d7))
* **deps:** update module github.com/schollz/progressbar/v3 to v3.14.5 ([#1145](https://github.com/tblakex01/k8sgpt/issues/1145)) ([3547c48](https://github.com/tblakex01/k8sgpt/commit/3547c4808a846eb4392996afa20a84bdddf8e24f))
* **deps:** update module github.com/schollz/progressbar/v3 to v3.15.0 ([#1227](https://github.com/tblakex01/k8sgpt/issues/1227)) ([025a069](https://github.com/tblakex01/k8sgpt/commit/025a069ff1582131cede63420aa535a3b550b7b7))
* **deps:** update module github.com/spf13/cobra to v1.8.1 ([#1161](https://github.com/tblakex01/k8sgpt/issues/1161)) ([a075792](https://github.com/tblakex01/k8sgpt/commit/a0757921191205398539a6ccc8dbfaa503db595f))
* **deps:** update module github.com/stretchr/testify to v1.9.0 ([#999](https://github.com/tblakex01/k8sgpt/issues/999)) ([1491e67](https://github.com/tblakex01/k8sgpt/commit/1491e675673dcc13ccf6ac1778113762542e8cbc))
* **deps:** update module go.uber.org/zap to v1.27.0 ([#972](https://github.com/tblakex01/k8sgpt/issues/972)) ([8f00218](https://github.com/tblakex01/k8sgpt/commit/8f002180901c8bf7e6b1a5451dd97ef566260b0f))
* **deps:** update module golang.org/x/net to v0.23.0 [security] ([#1071](https://github.com/tblakex01/k8sgpt/issues/1071)) ([693b23f](https://github.com/tblakex01/k8sgpt/commit/693b23f1fc33659a3c4f52fc4d9c23348b22bfb1))
* **deps:** update module golang.org/x/net to v0.25.0 ([#1092](https://github.com/tblakex01/k8sgpt/issues/1092)) ([fe53907](https://github.com/tblakex01/k8sgpt/commit/fe53907c44e9cd56b6747f52ae3402bc6ae2bd49))
* **deps:** update module golang.org/x/net to v0.33.0 [security] ([#1354](https://github.com/tblakex01/k8sgpt/issues/1354)) ([5de4f77](https://github.com/tblakex01/k8sgpt/commit/5de4f7704a856fd7db7b2f800bda40c5beb9333b))
* **deps:** update module golang.org/x/net to v0.36.0 [security] ([#1395](https://github.com/tblakex01/k8sgpt/issues/1395)) ([eb7b36a](https://github.com/tblakex01/k8sgpt/commit/eb7b36aa2764bc460ffc29a0aee18abe3631c2ed))
* **deps:** update module golang.org/x/net to v0.38.0 [security] ([#1462](https://github.com/tblakex01/k8sgpt/issues/1462)) ([e588fc3](https://github.com/tblakex01/k8sgpt/commit/e588fc316d29a29a7dde6abe2302833b38f1d302))
* **deps:** update module golang.org/x/term to v0.16.0 ([#831](https://github.com/tblakex01/k8sgpt/issues/831)) ([4de989c](https://github.com/tblakex01/k8sgpt/commit/4de989c803ee43a02d75112d1b3a54daee3dd9af))
* **deps:** update module golang.org/x/term to v0.17.0 ([#941](https://github.com/tblakex01/k8sgpt/issues/941)) ([4e57088](https://github.com/tblakex01/k8sgpt/commit/4e57088a0137767a42c778a59ff07fff04c04289))
* **deps:** update module google.golang.org/api to v0.155.0 ([#836](https://github.com/tblakex01/k8sgpt/issues/836)) ([105a239](https://github.com/tblakex01/k8sgpt/commit/105a239d94384f4096c01d9978564040773ab56e))
* **deps:** update module google.golang.org/api to v0.157.0 ([#860](https://github.com/tblakex01/k8sgpt/issues/860)) ([72e08ef](https://github.com/tblakex01/k8sgpt/commit/72e08efff1fc501dfcba791c9d940e575f3e2395))
* **deps:** update module google.golang.org/api to v0.164.0 ([#953](https://github.com/tblakex01/k8sgpt/issues/953)) ([29b482f](https://github.com/tblakex01/k8sgpt/commit/29b482f5978795fa8db729030bd75803e2e61f95))
* **deps:** update module google.golang.org/api to v0.165.0 ([#959](https://github.com/tblakex01/k8sgpt/issues/959)) ([cc99bd5](https://github.com/tblakex01/k8sgpt/commit/cc99bd51f05db4e87f806ac58ee1cb7a83b25e4d))
* **deps:** update module google.golang.org/api to v0.167.0 ([#973](https://github.com/tblakex01/k8sgpt/issues/973)) ([6103c96](https://github.com/tblakex01/k8sgpt/commit/6103c96c41e10e2fe13d285ff15a36bf2fbeb5c2))
* **deps:** update module google.golang.org/grpc to v1.61.1 ([#954](https://github.com/tblakex01/k8sgpt/issues/954)) ([9c1f1b8](https://github.com/tblakex01/k8sgpt/commit/9c1f1b8804a26f549379efe637d0bedb8e2cb890))
* **deps:** update module google.golang.org/grpc to v1.62.0 ([#975](https://github.com/tblakex01/k8sgpt/issues/975)) ([97446aa](https://github.com/tblakex01/k8sgpt/commit/97446aae079824d6556416314c0a27514088a667))
* **deps:** update module google.golang.org/grpc to v1.64.1 [security] ([#1178](https://github.com/tblakex01/k8sgpt/issues/1178)) ([dd20dbc](https://github.com/tblakex01/k8sgpt/commit/dd20dbc9829fc50f77ad6a32c3a10dcf221d2750))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#1296](https://github.com/tblakex01/k8sgpt/issues/1296)) ([2f75986](https://github.com/tblakex01/k8sgpt/commit/2f759865b6fc5ae143c8f5e89a306abc89d4de27))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#1303](https://github.com/tblakex01/k8sgpt/issues/1303)) ([2da0573](https://github.com/tblakex01/k8sgpt/commit/2da057360b378d34126e1480ade0686f104e3ace))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#1321](https://github.com/tblakex01/k8sgpt/issues/1321)) ([69c67bd](https://github.com/tblakex01/k8sgpt/commit/69c67bd1d9d4404816a8b7a00c98499729f2185f))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#1326](https://github.com/tblakex01/k8sgpt/issues/1326)) ([5514ebb](https://github.com/tblakex01/k8sgpt/commit/5514ebb53b79b5bac0fc861ffdebc9399fe87b62))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#1336](https://github.com/tblakex01/k8sgpt/issues/1336)) ([19abbef](https://github.com/tblakex01/k8sgpt/commit/19abbef9a3112ceb060ac3fd772e2e4f62f19f84))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#1363](https://github.com/tblakex01/k8sgpt/issues/1363)) ([e4861e9](https://github.com/tblakex01/k8sgpt/commit/e4861e9e2d631652b82768567afb9ba174114134))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#1417](https://github.com/tblakex01/k8sgpt/issues/1417)) ([ce4b3c2](https://github.com/tblakex01/k8sgpt/commit/ce4b3c2e7d0762093506d9010eceb47a2dcdf5bc))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#1447](https://github.com/tblakex01/k8sgpt/issues/1447)) ([969fe99](https://github.com/tblakex01/k8sgpt/commit/969fe99b3320c313f1c97133cdffb668a00d5fb5))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#1453](https://github.com/tblakex01/k8sgpt/issues/1453)) ([cf6f928](https://github.com/tblakex01/k8sgpt/commit/cf6f9289e13ee729c24968fd771c901f412e8db7))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#1454](https://github.com/tblakex01/k8sgpt/issues/1454)) ([d0f0364](https://github.com/tblakex01/k8sgpt/commit/d0f03641ae372a00cd0eca1f41ef30a988d436bc))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#1500](https://github.com/tblakex01/k8sgpt/issues/1500)) ([d308c51](https://github.com/tblakex01/k8sgpt/commit/d308c511fbe06e012c641dfa08c4dcf4181b243a))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#1509](https://github.com/tblakex01/k8sgpt/issues/1509)) ([d7cb19a](https://github.com/tblakex01/k8sgpt/commit/d7cb19ad29c92eaba552ba723945c937fc3c42da))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#1511](https://github.com/tblakex01/k8sgpt/issues/1511)) ([08f2855](https://github.com/tblakex01/k8sgpt/commit/08f2855a4d7e61f3422cb68b0966272a85f617a5))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#1537](https://github.com/tblakex01/k8sgpt/issues/1537)) ([50d5d78](https://github.com/tblakex01/k8sgpt/commit/50d5d78c06e42d75a2448989528e5e6be12ea825))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#1550](https://github.com/tblakex01/k8sgpt/issues/1550)) ([7fe3bdb](https://github.com/tblakex01/k8sgpt/commit/7fe3bdbd952bc9a1975121de5f21ad31dc1f691d))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#864](https://github.com/tblakex01/k8sgpt/issues/864)) ([36ba6c5](https://github.com/tblakex01/k8sgpt/commit/36ba6c5147a9ed75c14dbba4bc06cae903e651a4))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#865](https://github.com/tblakex01/k8sgpt/issues/865)) ([c55025d](https://github.com/tblakex01/k8sgpt/commit/c55025d04ebf9da0f6092aabb0b043ccef05164c))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#866](https://github.com/tblakex01/k8sgpt/issues/866)) ([81d6604](https://github.com/tblakex01/k8sgpt/commit/81d660447d236cd03b75866871bb69f2c77c5c66))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#875](https://github.com/tblakex01/k8sgpt/issues/875)) ([1f371e2](https://github.com/tblakex01/k8sgpt/commit/1f371e2807c47dbb4613bf873ec67a77e8e6c80c))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#956](https://github.com/tblakex01/k8sgpt/issues/956)) ([d9fe744](https://github.com/tblakex01/k8sgpt/commit/d9fe7446af428209610adc83ec17cf50491a5a47))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#957](https://github.com/tblakex01/k8sgpt/issues/957)) ([f929e7f](https://github.com/tblakex01/k8sgpt/commit/f929e7feea5931ddec77af49dd08937aca85fd49))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#979](https://github.com/tblakex01/k8sgpt/issues/979)) ([35f5185](https://github.com/tblakex01/k8sgpt/commit/35f51859140c78ce953443afcc27f77230287809))
* **deps:** update module gopkg.in/yaml.v2 to v3 ([#980](https://github.com/tblakex01/k8sgpt/issues/980)) ([334a86a](https://github.com/tblakex01/k8sgpt/commit/334a86aaf40e5421929cf380191841db064d9bf7))
* **deps:** update module helm.sh/helm/v3 to v3.17.3 [security] ([#1448](https://github.com/tblakex01/k8sgpt/issues/1448)) ([060a3b2](https://github.com/tblakex01/k8sgpt/commit/060a3b2a26f117827090697eb599cd51a44125e6))
* **deps:** update module helm.sh/helm/v3 to v3.17.4 [security] ([#1541](https://github.com/tblakex01/k8sgpt/issues/1541)) ([5b42249](https://github.com/tblakex01/k8sgpt/commit/5b4224951e7348e9d78292dadc9b9786957117f1))
* disable adding multiple openai provider ([#1191](https://github.com/tblakex01/k8sgpt/issues/1191)) ([644581f](https://github.com/tblakex01/k8sgpt/commit/644581f4958f470cfb088a69a478db0ab91c1540))
* enabled auth add support watsonx backend ([#1190](https://github.com/tblakex01/k8sgpt/issues/1190)) ([d702209](https://github.com/tblakex01/k8sgpt/commit/d702209941480dce62b9622ea30fdb4a9e5ef083))
* helm chart security context rendering if empty ([#1235](https://github.com/tblakex01/k8sgpt/issues/1235)) ([be4ca86](https://github.com/tblakex01/k8sgpt/commit/be4ca86af07e832eb7832f7e5f83df8676bafd29))
* invalid ParentObj in output ([#1068](https://github.com/tblakex01/k8sgpt/issues/1068)) ([b2ab943](https://github.com/tblakex01/k8sgpt/commit/b2ab94375e4233cdfa9762877995445c313bb962))
* issue-1168, remove duplicate CVE ([#1230](https://github.com/tblakex01/k8sgpt/issues/1230)) ([8edb053](https://github.com/tblakex01/k8sgpt/commit/8edb053b3e88027880a75999eab19bed2176747f))
* lint errors ([#923](https://github.com/tblakex01/k8sgpt/issues/923)) ([3415031](https://github.com/tblakex01/k8sgpt/commit/3415031006bb5899019e68d33ac6083d03ef864b))
* log analyzer failed with multiple containers in the pod ([#920](https://github.com/tblakex01/k8sgpt/issues/920)) ([98286a9](https://github.com/tblakex01/k8sgpt/commit/98286a965e4c4c680deeb43d3397b51089968366))
* migrated to more actively maintained mcp golang lib and added AI explain  ([#1557](https://github.com/tblakex01/k8sgpt/issues/1557)) ([c47ae59](https://github.com/tblakex01/k8sgpt/commit/c47ae595fb9fc5bf22afef3bc6764b3e87e4553d))
* panic in k8sgpt auth update ([#1497](https://github.com/tblakex01/k8sgpt/issues/1497)) ([cae94e7](https://github.com/tblakex01/k8sgpt/commit/cae94e7b6df1684a3b61af3e7aa0f4e68e8df594))
* pod analyzer catches errors when containers are in Terminated state ([#1438](https://github.com/tblakex01/k8sgpt/issues/1438)) ([dceda9a](https://github.com/tblakex01/k8sgpt/commit/dceda9a6a16a914b916c478ecd0b4c8ed0e19c40))
* prevent npe by handling checking error in NewAnalysis call ([#1365](https://github.com/tblakex01/k8sgpt/issues/1365)) ([83672fa](https://github.com/tblakex01/k8sgpt/commit/83672fa768887dd1c6f4dc12a92c3444f100c4f6))
* prometheus UTF8Validation ([#1404](https://github.com/tblakex01/k8sgpt/issues/1404)) ([3c353b0](https://github.com/tblakex01/k8sgpt/commit/3c353b0e931028f3be3b229518cf86d24422a29d))
* remove shorthand flag for topp option in add command ([#1115](https://github.com/tblakex01/k8sgpt/issues/1115)) ([e261c09](https://github.com/tblakex01/k8sgpt/commit/e261c09889359d5870acb9720ff033440f835f8f))
* remove show password in auth list ([#1061](https://github.com/tblakex01/k8sgpt/issues/1061)) ([9e02637](https://github.com/tblakex01/k8sgpt/commit/9e0263778f6dbc179184fa9d86f07d808283d63e))
* rename watsonxai to ibmwatsonxai ([#1234](https://github.com/tblakex01/k8sgpt/issues/1234)) ([5ff6dc9](https://github.com/tblakex01/k8sgpt/commit/5ff6dc9be5218e47839c4ac5e8f3458b40eb9c88))
* reverse hpa ScalingLimited error condition ([#1366](https://github.com/tblakex01/k8sgpt/issues/1366)) ([ebb0373](https://github.com/tblakex01/k8sgpt/commit/ebb0373f69ad64a6cc43d0695d07e1d076c6366e))
* segmentation violation during serve ([#1215](https://github.com/tblakex01/k8sgpt/issues/1215)) ([b7e5394](https://github.com/tblakex01/k8sgpt/commit/b7e5394caaabb43e01161618f7a6e9f4aa8f7408))
* set logger for controller-runtime ([#1211](https://github.com/tblakex01/k8sgpt/issues/1211)) ([8e37369](https://github.com/tblakex01/k8sgpt/commit/8e37369e5c6c96096b66179f22a27b2c0018c43a))
* set result name and namespace to trivy vulnreport and configaudi… ([#869](https://github.com/tblakex01/k8sgpt/issues/869)) ([a3cd7e6](https://github.com/tblakex01/k8sgpt/commit/a3cd7e6385365a1d190a9e8439311cb9d5eeda56))
* set topP from config ([#1053](https://github.com/tblakex01/k8sgpt/issues/1053)) ([c162cc2](https://github.com/tblakex01/k8sgpt/commit/c162cc22ee468070e0602d3fd684b022fa585c4f))
* shorthand for the http flag in serve command ([#969](https://github.com/tblakex01/k8sgpt/issues/969)) ([f55f837](https://github.com/tblakex01/k8sgpt/commit/f55f8370ebf0db6db629641337cd78ad7f120865))
* typo ([#1244](https://github.com/tblakex01/k8sgpt/issues/1244)) ([e02c0dd](https://github.com/tblakex01/k8sgpt/commit/e02c0ddd2d9f9a6fae8a57514468f26fe72b567a))
* typo in httproute files name ([#877](https://github.com/tblakex01/k8sgpt/issues/877)) ([cdbeb14](https://github.com/tblakex01/k8sgpt/commit/cdbeb146a28ebc21ac2c4d27e977b1771f9290b4))
* unused variable failure warning in webhooks file ([#916](https://github.com/tblakex01/k8sgpt/issues/916)) ([3f0964a](https://github.com/tblakex01/k8sgpt/commit/3f0964ad385390f53516904219fbfc47b989d31f))
* update OpenAI API key generation URL to reflect new platform link ([#1331](https://github.com/tblakex01/k8sgpt/issues/1331)) ([ec5e42b](https://github.com/tblakex01/k8sgpt/commit/ec5e42b8f43e90632bb62dd89cc6aa3665e0f60d))
* use MaxCompletionTokens instead of deprecated MaxTokens for OpenAI ([#1604](https://github.com/tblakex01/k8sgpt/issues/1604)) ([c80b2e2](https://github.com/tblakex01/k8sgpt/commit/c80b2e2c346845336593ce515fe90fd501b1d0a7))
* use proper JSON marshaling for customrest prompt to handle special characters ([#1615](https://github.com/tblakex01/k8sgpt/issues/1615)) ([99911fb](https://github.com/tblakex01/k8sgpt/commit/99911fbb3ac8c950fd7ee1b3210f8a9c2a6b0ad7)), closes [#1556](https://github.com/tblakex01/k8sgpt/issues/1556)
* validate namespace before running custom analyzers ([#1617](https://github.com/tblakex01/k8sgpt/issues/1617)) ([458aa9d](https://github.com/tblakex01/k8sgpt/commit/458aa9debac7590eb0855ffd12141b702e999a36))


### Other

* added new AmazonBedrock model  ([#1390](https://github.com/tblakex01/k8sgpt/issues/1390)) ([ad2c90a](https://github.com/tblakex01/k8sgpt/commit/ad2c90a129074a13dac4fdd8e918d8e26159c7a1))
* Adding region ([#1388](https://github.com/tblakex01/k8sgpt/issues/1388)) ([4f4f4f1](https://github.com/tblakex01/k8sgpt/commit/4f4f4f13a065ca7add283088c93777f78dcea228))
* allows an environmental override of the default AWS region and… ([#1025](https://github.com/tblakex01/k8sgpt/issues/1025)) ([8f8f5c6](https://github.com/tblakex01/k8sgpt/commit/8f8f5c6df7fbcd08ee48d91a4f2e011a3e69e4ac))
* attempt to group renovate deps ([#1007](https://github.com/tblakex01/k8sgpt/issues/1007)) ([adf4f17](https://github.com/tblakex01/k8sgpt/commit/adf4f17085672fd5ae78dad4f8ac1d887029836d))
* **deps:** pin codecov/codecov-action action to ab904c4 ([#1031](https://github.com/tblakex01/k8sgpt/issues/1031)) ([e0af76f](https://github.com/tblakex01/k8sgpt/commit/e0af76f3c9c0120dbc4d9373d69a262e1ec2b7f2))
* **deps:** pin dependencies ([#1440](https://github.com/tblakex01/k8sgpt/issues/1440)) ([a5574ee](https://github.com/tblakex01/k8sgpt/commit/a5574ee49d530960a515c419f4875cf02cb36fb3))
* **deps:** pin docker/build-push-action action to 471d1dc ([#1428](https://github.com/tblakex01/k8sgpt/issues/1428)) ([5086ccd](https://github.com/tblakex01/k8sgpt/commit/5086ccd65942ebb9a37bd2c3a48d16c4be99e8c1))
* **deps:** pin golangci/golangci-lint-action action to 1481404 ([#1415](https://github.com/tblakex01/k8sgpt/issues/1415)) ([e231032](https://github.com/tblakex01/k8sgpt/commit/e231032e1bec1d2d25cb03b35e701aa86a61d5ee))
* **deps:** pin goreleaser/goreleaser-action action to 286f3b1 ([#1171](https://github.com/tblakex01/k8sgpt/issues/1171)) ([1a00aaf](https://github.com/tblakex01/k8sgpt/commit/1a00aafbb2f6f1482dfb3da7e96954b12ad5a4fd))
* **deps:** update actions/checkout action to v5 ([#1562](https://github.com/tblakex01/k8sgpt/issues/1562)) ([e385e77](https://github.com/tblakex01/k8sgpt/commit/e385e77da93a65fe52a152bf1f8f1415552698d5))
* **deps:** update actions/checkout digest to 0ad4b8f ([#1078](https://github.com/tblakex01/k8sgpt/issues/1078)) ([ea8183c](https://github.com/tblakex01/k8sgpt/commit/ea8183ce848ba58f91cfa68755d6f5b9cf695d36))
* **deps:** update actions/checkout digest to 11bd719 ([#1283](https://github.com/tblakex01/k8sgpt/issues/1283)) ([0cfecbd](https://github.com/tblakex01/k8sgpt/commit/0cfecbdd87586fd138cc63c4e7a26d54e7ed83a8))
* **deps:** update actions/checkout digest to 692973e ([#1129](https://github.com/tblakex01/k8sgpt/issues/1129)) ([24ebeaf](https://github.com/tblakex01/k8sgpt/commit/24ebeaf3a748f2bf40c18ddcecaf8655b457048b))
* **deps:** update actions/checkout digest to 93cb6ef ([#1592](https://github.com/tblakex01/k8sgpt/issues/1592)) ([40ffcbe](https://github.com/tblakex01/k8sgpt/commit/40ffcbec6b65e3a99e40be5f414a3f2c087bffbb))
* **deps:** update actions/checkout digest to eef6144 ([#1270](https://github.com/tblakex01/k8sgpt/issues/1270)) ([72eb815](https://github.com/tblakex01/k8sgpt/commit/72eb8159fb4a2284cf43eb6a5f3de7bed10c6224))
* **deps:** update actions/setup-go digest to 0a12ed9 ([#1182](https://github.com/tblakex01/k8sgpt/issues/1182)) ([593139c](https://github.com/tblakex01/k8sgpt/commit/593139cffb1982fe45ccc9403acc893f51064271))
* **deps:** update actions/setup-go digest to 0aaccfd ([#1401](https://github.com/tblakex01/k8sgpt/issues/1401)) ([81d4aaf](https://github.com/tblakex01/k8sgpt/commit/81d4aaf402647bf4bcbc618fd82f9518cf3a5b4d))
* **deps:** update actions/setup-go digest to 3041bf5 ([#1347](https://github.com/tblakex01/k8sgpt/issues/1347)) ([939e067](https://github.com/tblakex01/k8sgpt/commit/939e0672aaaa5538cd58bb171f1e5d1c07831651))
* **deps:** update actions/setup-go digest to 40f1582 ([#1593](https://github.com/tblakex01/k8sgpt/issues/1593)) ([a303ffa](https://github.com/tblakex01/k8sgpt/commit/a303ffa21c7ede3dd9391185bc91fb3b4e8276b6))
* **deps:** update actions/setup-go digest to 41dfa10 ([#1284](https://github.com/tblakex01/k8sgpt/issues/1284)) ([2ce8450](https://github.com/tblakex01/k8sgpt/commit/2ce8450e03986904a7ffe7afac4b5ba777c67c57))
* **deps:** update actions/setup-go digest to cdcb360 ([#1096](https://github.com/tblakex01/k8sgpt/issues/1096)) ([3452c0d](https://github.com/tblakex01/k8sgpt/commit/3452c0def68fd5352d2d09201f813f657245bd9f))
* **deps:** update actions/setup-go digest to d35c59a ([#1495](https://github.com/tblakex01/k8sgpt/issues/1495)) ([e76bdb0](https://github.com/tblakex01/k8sgpt/commit/e76bdb0c23b7d23972d99661c8fe1bffe5f9f398))
* **deps:** update actions/setup-go digest to f111f33 ([#1364](https://github.com/tblakex01/k8sgpt/issues/1364)) ([f2fdfd8](https://github.com/tblakex01/k8sgpt/commit/f2fdfd8dcaae6f57378d50396c4746d738d38bf2))
* **deps:** update actions/upload-artifact digest to 0b2256b ([#1175](https://github.com/tblakex01/k8sgpt/issues/1175)) ([4b13727](https://github.com/tblakex01/k8sgpt/commit/4b13727ef579240adc2777d1126544fafb23b993))
* **deps:** update actions/upload-artifact digest to 1eb3cb2 ([#867](https://github.com/tblakex01/k8sgpt/issues/867)) ([4ce56f3](https://github.com/tblakex01/k8sgpt/commit/4ce56f38b4338a6a2fe69f588b0f17e0b54d0ae6))
* **deps:** update actions/upload-artifact digest to 26f96df ([#888](https://github.com/tblakex01/k8sgpt/issues/888)) ([483a9da](https://github.com/tblakex01/k8sgpt/commit/483a9dad103ad1af82491dc1d5e0a39bb4865a1b))
* **deps:** update actions/upload-artifact digest to 4cec3d8 ([#1378](https://github.com/tblakex01/k8sgpt/issues/1378)) ([093975e](https://github.com/tblakex01/k8sgpt/commit/093975e50ddadeab70a7c4f544df8351ac9758a2))
* **deps:** update actions/upload-artifact digest to 5076954 ([#1239](https://github.com/tblakex01/k8sgpt/issues/1239)) ([e0e86ea](https://github.com/tblakex01/k8sgpt/commit/e0e86ea60f3811e8ee22fd9c28e91817c56104a2))
* **deps:** update actions/upload-artifact digest to 5d5d22a ([#925](https://github.com/tblakex01/k8sgpt/issues/925)) ([070aa7f](https://github.com/tblakex01/k8sgpt/commit/070aa7fdd0982c0c7f02a1da9e6797d5efaa5586))
* **deps:** update actions/upload-artifact digest to 6546280 ([#1079](https://github.com/tblakex01/k8sgpt/issues/1079)) ([9b797d7](https://github.com/tblakex01/k8sgpt/commit/9b797d7e8b4f704dae12acaa7778b6b65e2c36ac))
* **deps:** update actions/upload-artifact digest to 65c4c4a ([#1350](https://github.com/tblakex01/k8sgpt/issues/1350)) ([c506a4b](https://github.com/tblakex01/k8sgpt/commit/c506a4b441e24052398c00c93d96806cec1b9f75))
* **deps:** update actions/upload-artifact digest to 694cdab ([#880](https://github.com/tblakex01/k8sgpt/issues/880)) ([3cf18e7](https://github.com/tblakex01/k8sgpt/commit/3cf18e783edb341b7bdd6aa20dbcce11971fa241))
* **deps:** update actions/upload-artifact digest to 834a144 ([#1214](https://github.com/tblakex01/k8sgpt/issues/1214)) ([2a8a9b4](https://github.com/tblakex01/k8sgpt/commit/2a8a9b486714d780c0df3ecae8757534249731dc))
* **deps:** update actions/upload-artifact digest to b4b15b8 ([#1272](https://github.com/tblakex01/k8sgpt/issues/1272)) ([911d578](https://github.com/tblakex01/k8sgpt/commit/911d578bf006253d10fe21d96888ddf34a8b4691))
* **deps:** update actions/upload-artifact digest to ea165f8 ([#1402](https://github.com/tblakex01/k8sgpt/issues/1402)) ([eb381b8](https://github.com/tblakex01/k8sgpt/commit/eb381b8087bbb3216d9bcdcc88a71fbad9e31e41))
* **deps:** update actions/upload-artifact digest to ea165f8 ([#1425](https://github.com/tblakex01/k8sgpt/issues/1425)) ([9bffc7c](https://github.com/tblakex01/k8sgpt/commit/9bffc7cff776733f6d05669e6c02f594ee2db261))
* **deps:** update all non-major dependencies ([#1304](https://github.com/tblakex01/k8sgpt/issues/1304)) ([32e8bc3](https://github.com/tblakex01/k8sgpt/commit/32e8bc3253a568ac35b5d7f8b184cd2d34585d72))
* **deps:** update all non-major dependencies ([#1327](https://github.com/tblakex01/k8sgpt/issues/1327)) ([a841568](https://github.com/tblakex01/k8sgpt/commit/a841568a9c4c0012291cf8f4248250192b72a383))
* **deps:** update amannn/action-semantic-pull-request action to v5.5.2 ([#1088](https://github.com/tblakex01/k8sgpt/issues/1088)) ([a809a45](https://github.com/tblakex01/k8sgpt/commit/a809a455f55d1af104ebc0540007aa678581dd21))
* **deps:** update amannn/action-semantic-pull-request action to v5.5.3 ([#1172](https://github.com/tblakex01/k8sgpt/issues/1172)) ([27ac60a](https://github.com/tblakex01/k8sgpt/commit/27ac60aed296c3d9582f34e14c5985a4bccd991e))
* **deps:** update amannn/action-semantic-pull-request action to v6 ([#1565](https://github.com/tblakex01/k8sgpt/issues/1565)) ([c5c9135](https://github.com/tblakex01/k8sgpt/commit/c5c9135900ec6f95b63dac47df751269e7420e87))
* **deps:** update anchore/sbom-action action to v0.15.10 ([#1044](https://github.com/tblakex01/k8sgpt/issues/1044)) ([e05a902](https://github.com/tblakex01/k8sgpt/commit/e05a902d904fc0b63998ae290f15e79d330317fb))
* **deps:** update anchore/sbom-action action to v0.15.11 ([#1082](https://github.com/tblakex01/k8sgpt/issues/1082)) ([12fa5ae](https://github.com/tblakex01/k8sgpt/commit/12fa5aef4dada597d7059e5717ec7bee3b38c122))
* **deps:** update anchore/sbom-action action to v0.15.3 ([#850](https://github.com/tblakex01/k8sgpt/issues/850)) ([12f764d](https://github.com/tblakex01/k8sgpt/commit/12f764d5846accbd987d40f69a153dceb9954f39))
* **deps:** update anchore/sbom-action action to v0.15.4 ([#879](https://github.com/tblakex01/k8sgpt/issues/879)) ([d213399](https://github.com/tblakex01/k8sgpt/commit/d2133991617697b13b8846f2acb3a3bb6cebb160))
* **deps:** update anchore/sbom-action action to v0.15.5 ([#885](https://github.com/tblakex01/k8sgpt/issues/885)) ([60853fe](https://github.com/tblakex01/k8sgpt/commit/60853fe4eb8de7a1fdbaea388c3d2d6205e273a6))
* **deps:** update anchore/sbom-action action to v0.15.8 ([#926](https://github.com/tblakex01/k8sgpt/issues/926)) ([f61c3e2](https://github.com/tblakex01/k8sgpt/commit/f61c3e228c69fa160735ddb2c1347720112b738f))
* **deps:** update anchore/sbom-action action to v0.15.9 ([#1004](https://github.com/tblakex01/k8sgpt/issues/1004)) ([b05b6a3](https://github.com/tblakex01/k8sgpt/commit/b05b6a38ed4a9fc017f9dcb52cff8a332c11056d))
* **deps:** update anchore/sbom-action action to v0.16.0 ([#1146](https://github.com/tblakex01/k8sgpt/issues/1146)) ([dd66355](https://github.com/tblakex01/k8sgpt/commit/dd6635579789ce65ee86dc1196e7dfde1b7d20e6))
* **deps:** update anchore/sbom-action action to v0.16.1 ([#1179](https://github.com/tblakex01/k8sgpt/issues/1179)) ([3e93409](https://github.com/tblakex01/k8sgpt/commit/3e9340925c3d59861b1a95d5c1bc08c19ec26e4a))
* **deps:** update anchore/sbom-action action to v0.17.0 ([#1197](https://github.com/tblakex01/k8sgpt/issues/1197)) ([407c855](https://github.com/tblakex01/k8sgpt/commit/407c855e147b73739e800310c926826344d36323))
* **deps:** update anchore/sbom-action action to v0.17.1 ([#1224](https://github.com/tblakex01/k8sgpt/issues/1224)) ([f573819](https://github.com/tblakex01/k8sgpt/commit/f57381961fbc63305d9e9aa63e85a90a100ee553))
* **deps:** update anchore/sbom-action action to v0.17.2 ([#1248](https://github.com/tblakex01/k8sgpt/issues/1248)) ([04582d8](https://github.com/tblakex01/k8sgpt/commit/04582d85160055da30e4e00fd3c6ca69d1decd1a))
* **deps:** update anchore/sbom-action action to v0.17.4 ([#1273](https://github.com/tblakex01/k8sgpt/issues/1273)) ([c128bf7](https://github.com/tblakex01/k8sgpt/commit/c128bf7942e380fcab5e9771f405471198e388fe))
* **deps:** update anchore/sbom-action action to v0.17.6 ([#1285](https://github.com/tblakex01/k8sgpt/issues/1285)) ([173e4dc](https://github.com/tblakex01/k8sgpt/commit/173e4dc5ac6265af4a3538556220d3a43ab721f7))
* **deps:** update codecov/codecov-action action to v4 ([#1292](https://github.com/tblakex01/k8sgpt/issues/1292)) ([c1a38c2](https://github.com/tblakex01/k8sgpt/commit/c1a38c2b35a0bfa772b88f15843c9354b0345284))
* **deps:** update codecov/codecov-action action to v5 ([#1324](https://github.com/tblakex01/k8sgpt/issues/1324)) ([cb1e1ff](https://github.com/tblakex01/k8sgpt/commit/cb1e1ffede1d3086d54157142c6803341e560ca8))
* **deps:** update codecov/codecov-action digest to 015f24e ([#1325](https://github.com/tblakex01/k8sgpt/issues/1325)) ([4d7eb0f](https://github.com/tblakex01/k8sgpt/commit/4d7eb0f6226fc50f58b5c2fff7534dd16e2ca378))
* **deps:** update codecov/codecov-action digest to 0565863 ([#1387](https://github.com/tblakex01/k8sgpt/issues/1387)) ([2a6f485](https://github.com/tblakex01/k8sgpt/commit/2a6f48500c4567519453fc51ea070f5e407d3cfb))
* **deps:** update codecov/codecov-action digest to 13ce06b ([#1342](https://github.com/tblakex01/k8sgpt/issues/1342)) ([990d723](https://github.com/tblakex01/k8sgpt/commit/990d7239091b368178e06af60e4dc0e897fc8236))
* **deps:** update codecov/codecov-action digest to 18283e0 ([#1513](https://github.com/tblakex01/k8sgpt/issues/1513)) ([42654e7](https://github.com/tblakex01/k8sgpt/commit/42654e7f55d7a9e9be5b664adaaa8979106e7298))
* **deps:** update codecov/codecov-action digest to ad3126e ([#1456](https://github.com/tblakex01/k8sgpt/issues/1456)) ([0553b98](https://github.com/tblakex01/k8sgpt/commit/0553b984b7c87b345f171bf6e5d632d890db689c))
* **deps:** update cohere client implementation to v2  ([#1062](https://github.com/tblakex01/k8sgpt/issues/1062)) ([eb7687a](https://github.com/tblakex01/k8sgpt/commit/eb7687a08917ad4048c6f00c17bb45591a935a3a))
* **deps:** update dependency go to v1.23.1 ([#1176](https://github.com/tblakex01/k8sgpt/issues/1176)) ([453d5c3](https://github.com/tblakex01/k8sgpt/commit/453d5c37ddafd93c6fa194b5b4fc0794154eb8c1))
* **deps:** update dependency ubuntu to v24 ([#1293](https://github.com/tblakex01/k8sgpt/issues/1293)) ([c67add3](https://github.com/tblakex01/k8sgpt/commit/c67add30c64257ac6258dec93193e3201ba8c4ab))
* **deps:** update docker/build-push-action action to v6 ([#1294](https://github.com/tblakex01/k8sgpt/issues/1294)) ([f37d923](https://github.com/tblakex01/k8sgpt/commit/f37d92391877819c6d26a993ab58bc0c49fb3b66))
* **deps:** update docker/build-push-action digest to 14487ce ([#1472](https://github.com/tblakex01/k8sgpt/issues/1472)) ([81da402](https://github.com/tblakex01/k8sgpt/commit/81da402d46e1a1db83a41b717dfb23eb07d2e919))
* **deps:** update docker/build-push-action digest to 1dc7386 ([#1512](https://github.com/tblakex01/k8sgpt/issues/1512)) ([dfcc5dc](https://github.com/tblakex01/k8sgpt/commit/dfcc5dc5a15a3d59a7f6317944784e3ecd86fb50))
* **deps:** update docker/build-push-action digest to 2634353 ([#1517](https://github.com/tblakex01/k8sgpt/issues/1517)) ([7dfe8be](https://github.com/tblakex01/k8sgpt/commit/7dfe8bef0face65f607475a6620923fdfed57961))
* **deps:** update docker/build-push-action digest to 2cdde99 ([#1032](https://github.com/tblakex01/k8sgpt/issues/1032)) ([b12c006](https://github.com/tblakex01/k8sgpt/commit/b12c006c6304165269b90d770048b851e1aa1d1f))
* **deps:** update docker/build-push-action digest to 471d1dc ([#1358](https://github.com/tblakex01/k8sgpt/issues/1358)) ([f2e3b9a](https://github.com/tblakex01/k8sgpt/commit/f2e3b9a8a72c4df32713197e50756e37e1302ff9))
* **deps:** update docker/build-push-action digest to 48aba3b ([#1333](https://github.com/tblakex01/k8sgpt/issues/1333)) ([c21ba86](https://github.com/tblakex01/k8sgpt/commit/c21ba86237db651086c0a37abc3454db513e505b))
* **deps:** update docker/build-push-action digest to af5a7ed ([#1003](https://github.com/tblakex01/k8sgpt/issues/1003)) ([b58b719](https://github.com/tblakex01/k8sgpt/commit/b58b7191af2fe082d94d46ef6a2784c1ea322340))
* **deps:** update docker/build-push-action digest to ca052bb ([#1140](https://github.com/tblakex01/k8sgpt/issues/1140)) ([0c02160](https://github.com/tblakex01/k8sgpt/commit/0c0216096efde9c2c812ee90522c081f51c52631))
* **deps:** update docker/login-action digest to 0d4c9c5 ([#1141](https://github.com/tblakex01/k8sgpt/issues/1141)) ([602d111](https://github.com/tblakex01/k8sgpt/commit/602d111d8568d38cda744d2b179ee2d3eb59ba02))
* **deps:** update docker/login-action digest to 184bdaa ([#1559](https://github.com/tblakex01/k8sgpt/issues/1559)) ([0239b2f](https://github.com/tblakex01/k8sgpt/commit/0239b2fe6e7105bbcf3256c559c30ec7065b25f3))
* **deps:** update docker/login-action digest to 74a5d14 ([#1397](https://github.com/tblakex01/k8sgpt/issues/1397)) ([fdf8e7a](https://github.com/tblakex01/k8sgpt/commit/fdf8e7a95a6667b782e1e347a3b1d2fb0f2aafde))
* **deps:** update docker/login-action digest to 9780b0c ([#1212](https://github.com/tblakex01/k8sgpt/issues/1212)) ([477ef15](https://github.com/tblakex01/k8sgpt/commit/477ef155d32f4d81ca3bee612644f51fc1098cdc))
* **deps:** update docker/login-action digest to e92390c ([#1033](https://github.com/tblakex01/k8sgpt/issues/1033)) ([c872e49](https://github.com/tblakex01/k8sgpt/commit/c872e495ad6f787cf566a5b2f295deb3f08aba15))
* **deps:** update docker/setup-buildx-action digest to 0d103c3 ([#988](https://github.com/tblakex01/k8sgpt/issues/988)) ([f24bcd8](https://github.com/tblakex01/k8sgpt/commit/f24bcd88b6a915798897b49a562b86265a9b524c))
* **deps:** update docker/setup-buildx-action digest to 2b51285 ([#1036](https://github.com/tblakex01/k8sgpt/issues/1036)) ([10c00ba](https://github.com/tblakex01/k8sgpt/commit/10c00ba9fe61a3ee1dc90d87dd7997da276905b4))
* **deps:** update docker/setup-buildx-action digest to 4fd8129 ([#1173](https://github.com/tblakex01/k8sgpt/issues/1173)) ([d4abb33](https://github.com/tblakex01/k8sgpt/commit/d4abb33b3c29d9a2e4dee094ea7be2bc5d1807d1))
* **deps:** update docker/setup-buildx-action digest to 6524bf6 ([#1349](https://github.com/tblakex01/k8sgpt/issues/1349)) ([2918556](https://github.com/tblakex01/k8sgpt/commit/2918556793316ea4f5a319c9aa51c1fec12ede85))
* **deps:** update docker/setup-buildx-action digest to b5ca514 ([#1371](https://github.com/tblakex01/k8sgpt/issues/1371)) ([d4de5d9](https://github.com/tblakex01/k8sgpt/commit/d4de5d9e3fdd1cc4c7d6fc067a7426fef1d32c1d))
* **deps:** update docker/setup-buildx-action digest to c47758b ([#1213](https://github.com/tblakex01/k8sgpt/issues/1213)) ([161bc11](https://github.com/tblakex01/k8sgpt/commit/161bc11294d5094533068cf7af9880795a61536e))
* **deps:** update docker/setup-buildx-action digest to d70bba7 ([#1066](https://github.com/tblakex01/k8sgpt/issues/1066)) ([3eaf776](https://github.com/tblakex01/k8sgpt/commit/3eaf776249719a0a13909d24e6b48deb6bf818b6))
* **deps:** update docker/setup-buildx-action digest to e468171 ([#1527](https://github.com/tblakex01/k8sgpt/issues/1527)) ([0c917fc](https://github.com/tblakex01/k8sgpt/commit/0c917fc60115ef0dc775e858a55964382b20c5e1))
* **deps:** update golang docker tag to v1.22 ([#931](https://github.com/tblakex01/k8sgpt/issues/931)) ([37228d8](https://github.com/tblakex01/k8sgpt/commit/37228d88e357c66c5574559ae27a52fdf28418b8))
* **deps:** update golang docker tag to v1.23 ([#1254](https://github.com/tblakex01/k8sgpt/issues/1254)) ([b62b7db](https://github.com/tblakex01/k8sgpt/commit/b62b7dbe3c9cd02b81f6a0111bca939034c5cc9f))
* **deps:** update golangci/golangci-lint-action action to v8 ([#1490](https://github.com/tblakex01/k8sgpt/issues/1490)) ([1e57b77](https://github.com/tblakex01/k8sgpt/commit/1e57b7774c20bda4ae0b0d765278bcd3504cfb33))
* **deps:** update golangci/golangci-lint-action digest to 9fae48a ([#1489](https://github.com/tblakex01/k8sgpt/issues/1489)) ([d5341f3](https://github.com/tblakex01/k8sgpt/commit/d5341f3c0019c1114254ac05f00c743a0354ec0b))
* **deps:** update google-github-actions/release-please-action action to v4.1.0 ([#1045](https://github.com/tblakex01/k8sgpt/issues/1045)) ([bf6f642](https://github.com/tblakex01/k8sgpt/commit/bf6f642c280f640f2c9020b325e52670ced2cf50))
* **deps:** update google-github-actions/release-please-action action to v4.1.1 ([#1143](https://github.com/tblakex01/k8sgpt/issues/1143)) ([63b63f7](https://github.com/tblakex01/k8sgpt/commit/63b63f7664277042188351073f269569bfec65bf))
* **deps:** update goreleaser/goreleaser-action digest to 5742e2a ([#1142](https://github.com/tblakex01/k8sgpt/issues/1142)) ([c101e8a](https://github.com/tblakex01/k8sgpt/commit/c101e8a3ea6d911d00ca2a51986edc5425a1042a))
* **deps:** update goreleaser/goreleaser-action digest to 5742e2a ([#1153](https://github.com/tblakex01/k8sgpt/issues/1153)) ([55ae7c3](https://github.com/tblakex01/k8sgpt/commit/55ae7c32986100d4b0bab6dcaf7a52ac7b37aa5f))
* **deps:** update goreleaser/goreleaser-action digest to 90a3faa ([#1308](https://github.com/tblakex01/k8sgpt/issues/1308)) ([d6d2e3b](https://github.com/tblakex01/k8sgpt/commit/d6d2e3bc4254877c8af61aba7386706e942e3fe9))
* **deps:** update goreleaser/goreleaser-action digest to 9c156ee ([#1411](https://github.com/tblakex01/k8sgpt/issues/1411)) ([c823de1](https://github.com/tblakex01/k8sgpt/commit/c823de12e6b6efcf9f5639665aac602ed85ae31d))
* **deps:** update goreleaser/goreleaser-action digest to e435ccd ([#1569](https://github.com/tblakex01/k8sgpt/issues/1569)) ([5e86f49](https://github.com/tblakex01/k8sgpt/commit/5e86f4925c4209b0eb2959227229c2994cfc5b6f))
* **deps:** update module github.com/docker/docker to v27.3.1+incompatible ([#1225](https://github.com/tblakex01/k8sgpt/issues/1225)) ([9c1927b](https://github.com/tblakex01/k8sgpt/commit/9c1927b4975fa8132fbc24dd96a5737819855544))
* **deps:** update module github.com/docker/docker to v28 ([#1376](https://github.com/tblakex01/k8sgpt/issues/1376)) ([68ddac0](https://github.com/tblakex01/k8sgpt/commit/68ddac008955933ffa27c2c4e46d286d9a26e100))
* **deps:** update rajatjindal/krew-release-bot action to v0.0.47 ([#1317](https://github.com/tblakex01/k8sgpt/issues/1317)) ([896a53b](https://github.com/tblakex01/k8sgpt/commit/896a53be8394c490e2d34f151de44c3663dddf5b))
* **deps:** update reviewdog/action-golangci-lint digest to 00311c2 ([#1002](https://github.com/tblakex01/k8sgpt/issues/1002)) ([4ec143a](https://github.com/tblakex01/k8sgpt/commit/4ec143ab772ca4dc3072c248e95da8f7c0a2974b))
* **deps:** update reviewdog/action-golangci-lint digest to 7708105 ([#1157](https://github.com/tblakex01/k8sgpt/issues/1157)) ([7b1b633](https://github.com/tblakex01/k8sgpt/commit/7b1b63322ec7b0c0864682bc23be6e70c0ed7ec7))
* **deps:** update reviewdog/action-golangci-lint digest to 8e1117c ([#915](https://github.com/tblakex01/k8sgpt/issues/915)) ([599be33](https://github.com/tblakex01/k8sgpt/commit/599be33f38ad1fd688b8e7824102a7944d516435))
* **deps:** update reviewdog/action-golangci-lint digest to f016e79 ([#714](https://github.com/tblakex01/k8sgpt/issues/714)) ([335616c](https://github.com/tblakex01/k8sgpt/commit/335616c20f7f8d9fefab4976d986a8d3b4867111))
* **deps:** update softprops/action-gh-release action to v2 ([#1295](https://github.com/tblakex01/k8sgpt/issues/1295)) ([b6b3d0c](https://github.com/tblakex01/k8sgpt/commit/b6b3d0c8566b0dbd9cb0e5f59c8493e4343e0106))
* **deps:** update softprops/action-gh-release digest to 72f2c25 ([#1526](https://github.com/tblakex01/k8sgpt/issues/1526)) ([5947876](https://github.com/tblakex01/k8sgpt/commit/5947876e4942729eea883937faf5e2b47d1f16ec))
* **deps:** update softprops/action-gh-release digest to c95fe14 ([#1359](https://github.com/tblakex01/k8sgpt/issues/1359)) ([db5e517](https://github.com/tblakex01/k8sgpt/commit/db5e517dbb23a4cb0f203427744f4007d6e9faa8))
* **deps:** update softprops/action-gh-release digest to d5382d3 ([#1525](https://github.com/tblakex01/k8sgpt/issues/1525)) ([6b9f346](https://github.com/tblakex01/k8sgpt/commit/6b9f346bf668ed3517b23b99000611ea14afafe2))
* **deps:** update softprops/action-gh-release digest to da05d55 ([#1464](https://github.com/tblakex01/k8sgpt/issues/1464)) ([4434699](https://github.com/tblakex01/k8sgpt/commit/443469960a6b6791e358ee0a97e4c1dc5c3018e6))
* fix error ([#1403](https://github.com/tblakex01/k8sgpt/issues/1403)) ([288ca86](https://github.com/tblakex01/k8sgpt/commit/288ca862b3aaf942e58aa0dad0e15e2fda84780f))
* fix typo in "completion" ([#1362](https://github.com/tblakex01/k8sgpt/issues/1362)) ([06b8f78](https://github.com/tblakex01/k8sgpt/commit/06b8f78150308c1f6023747fa34826e038d6bc3a))
* fix workflows ([#1423](https://github.com/tblakex01/k8sgpt/issues/1423)) ([3dbc9e1](https://github.com/tblakex01/k8sgpt/commit/3dbc9e1a20a3a55971733d990ecd39e798a804e9))
* fixed the goreleaser file ([#1158](https://github.com/tblakex01/k8sgpt/issues/1158)) ([2382de4](https://github.com/tblakex01/k8sgpt/commit/2382de4c6f82de535b67c2752d7c502d0a8b2b66))
* fixing ([#1437](https://github.com/tblakex01/k8sgpt/issues/1437)) ([f68ff0e](https://github.com/tblakex01/k8sgpt/commit/f68ff0efee9bad5f8368c83800611fa9acbc53d7))
* fixing build ([#1431](https://github.com/tblakex01/k8sgpt/issues/1431)) ([c5fe2c6](https://github.com/tblakex01/k8sgpt/commit/c5fe2c68d18d4fd713b3e638066327ad586d1871))
* fixing docker build push action ([#1426](https://github.com/tblakex01/k8sgpt/issues/1426)) ([1681aad](https://github.com/tblakex01/k8sgpt/commit/1681aadac106c608de9774ebfd7ea9df20eed482))
* golangci lint ([#1508](https://github.com/tblakex01/k8sgpt/issues/1508)) ([4faf77d](https://github.com/tblakex01/k8sgpt/commit/4faf77d91a3da8fdd6166ec1c381a151e5846057))
* grpc update ([#938](https://github.com/tblakex01/k8sgpt/issues/938)) ([bbf61f5](https://github.com/tblakex01/k8sgpt/commit/bbf61f53d4fb9244b5a79ae953370296ca9fd44b))
* improve codebase and doc quality ([#922](https://github.com/tblakex01/k8sgpt/issues/922)) ([d97dea2](https://github.com/tblakex01/k8sgpt/commit/d97dea289681cd061ca0796208c50720bdb08914))
* lint fixes ([#833](https://github.com/tblakex01/k8sgpt/issues/833)) ([a7e9b48](https://github.com/tblakex01/k8sgpt/commit/a7e9b486bad7c2d62878e470a755d1fef3803680))
* linter ([#1414](https://github.com/tblakex01/k8sgpt/issues/1414)) ([f0b18cf](https://github.com/tblakex01/k8sgpt/commit/f0b18cfb1cd418b94b448d3b9de43f03841c92bb))
* linting improvements and catching false positives ([#882](https://github.com/tblakex01/k8sgpt/issues/882)) ([2effbb3](https://github.com/tblakex01/k8sgpt/commit/2effbb345ad1c2771ec798e06ccde68d3253b4bc))
* **main:** release 0.3.25 ([#812](https://github.com/tblakex01/k8sgpt/issues/812)) ([6d29fcf](https://github.com/tblakex01/k8sgpt/commit/6d29fcf294eb72d45df4b6643afbc23eab108474))
* **main:** release 0.3.26 ([#846](https://github.com/tblakex01/k8sgpt/issues/846)) ([6d3a393](https://github.com/tblakex01/k8sgpt/commit/6d3a3933cdf99477f78c3cb499b06e183b8e03e8))
* **main:** release 0.3.27 ([#870](https://github.com/tblakex01/k8sgpt/issues/870)) ([729d14d](https://github.com/tblakex01/k8sgpt/commit/729d14db4dfff4b821a1d984efb4f07295929898))
* **main:** release 0.3.28 ([#964](https://github.com/tblakex01/k8sgpt/issues/964)) ([ea7f0a5](https://github.com/tblakex01/k8sgpt/commit/ea7f0a5b4e7e4ccb6172f0349d53c399e1fdb1ee))
* **main:** release 0.3.29 ([#1024](https://github.com/tblakex01/k8sgpt/issues/1024)) ([5db4bc2](https://github.com/tblakex01/k8sgpt/commit/5db4bc28a7c3cc485865b17633e96f497c760f87))
* **main:** release 0.3.30 ([#1027](https://github.com/tblakex01/k8sgpt/issues/1027)) ([6279f35](https://github.com/tblakex01/k8sgpt/commit/6279f358cae02b674b262349ff3194fceef807c3))
* **main:** release 0.3.31 ([#1077](https://github.com/tblakex01/k8sgpt/issues/1077)) ([cc890df](https://github.com/tblakex01/k8sgpt/commit/cc890dfa46f91ff2f25311e578d0abbe19c8fabc))
* **main:** release 0.3.32 ([#1119](https://github.com/tblakex01/k8sgpt/issues/1119)) ([ffd017f](https://github.com/tblakex01/k8sgpt/commit/ffd017fbd7276f6abf879aa106fc91e182f05dab))
* **main:** release 0.3.33 ([#1128](https://github.com/tblakex01/k8sgpt/issues/1128)) ([0fe9849](https://github.com/tblakex01/k8sgpt/commit/0fe984966a2b6abf18c14e21f9374dd9469a595b))
* **main:** release 0.3.34 ([#1144](https://github.com/tblakex01/k8sgpt/issues/1144)) ([038e52e](https://github.com/tblakex01/k8sgpt/commit/038e52e0442b3b2043caae9dc6ef066b74e05844))
* **main:** release 0.3.35 ([#1150](https://github.com/tblakex01/k8sgpt/issues/1150)) ([c3f164e](https://github.com/tblakex01/k8sgpt/commit/c3f164eb2b7fee572d2dd77c30c05b3d245e05c3))
* **main:** release 0.3.36 ([#1152](https://github.com/tblakex01/k8sgpt/issues/1152)) ([f963e4e](https://github.com/tblakex01/k8sgpt/commit/f963e4e0f47dad8556c460e675aef839385f160c))
* **main:** release 0.3.37 ([#1159](https://github.com/tblakex01/k8sgpt/issues/1159)) ([3f80bba](https://github.com/tblakex01/k8sgpt/commit/3f80bbaa1b07f69d6033cc4df4b9b30c41e259e6))
* **main:** release 0.3.38 ([#1165](https://github.com/tblakex01/k8sgpt/issues/1165)) ([f6ce47c](https://github.com/tblakex01/k8sgpt/commit/f6ce47c3a9b2cbc82c48c8497c8ca30b0fb9be14))
* **main:** release 0.3.39 ([#1181](https://github.com/tblakex01/k8sgpt/issues/1181)) ([3c08118](https://github.com/tblakex01/k8sgpt/commit/3c08118104c3b7da4bc797269c092162c02d9a23))
* **main:** release 0.3.40 ([#1202](https://github.com/tblakex01/k8sgpt/issues/1202)) ([ad117a5](https://github.com/tblakex01/k8sgpt/commit/ad117a530f1e0176ec203eaa2161413b6488840d))
* **main:** release 0.3.41 ([#1217](https://github.com/tblakex01/k8sgpt/issues/1217)) ([f071b32](https://github.com/tblakex01/k8sgpt/commit/f071b32aa85d77b197cd2d0f9868294f7b55c5eb))
* **main:** release 0.3.42 ([#1258](https://github.com/tblakex01/k8sgpt/issues/1258)) ([9d68c47](https://github.com/tblakex01/k8sgpt/commit/9d68c470409a693e0cd313a31f1e3f851fc3f607))
* **main:** release 0.3.43 ([#1301](https://github.com/tblakex01/k8sgpt/issues/1301)) ([8ad2881](https://github.com/tblakex01/k8sgpt/commit/8ad288152f5f1cb5c4297d44810c4f3cc8af0b24))
* **main:** release 0.3.44 ([#1311](https://github.com/tblakex01/k8sgpt/issues/1311)) ([62ba6d8](https://github.com/tblakex01/k8sgpt/commit/62ba6d84a4732f98ec58977cd1877ba9609ccd3b))
* **main:** release 0.3.45 ([#1314](https://github.com/tblakex01/k8sgpt/issues/1314)) ([44f4f74](https://github.com/tblakex01/k8sgpt/commit/44f4f7437f8b33a13033227468c34f588369230b))
* **main:** release 0.3.46 ([#1316](https://github.com/tblakex01/k8sgpt/issues/1316)) ([69fd7c7](https://github.com/tblakex01/k8sgpt/commit/69fd7c7696a8ee24761360a2d694d910ed0eac15))
* **main:** release 0.3.47 ([#1320](https://github.com/tblakex01/k8sgpt/issues/1320)) ([c3f4486](https://github.com/tblakex01/k8sgpt/commit/c3f448693d7648a1a98dbf1f714464d1b0724f89))
* **main:** release 0.3.48 ([#1341](https://github.com/tblakex01/k8sgpt/issues/1341)) ([1827c43](https://github.com/tblakex01/k8sgpt/commit/1827c43696d398afd789349f53b2d6bec2225eda))
* **main:** release 0.3.49 ([#1345](https://github.com/tblakex01/k8sgpt/issues/1345)) ([3b85f09](https://github.com/tblakex01/k8sgpt/commit/3b85f09348c439236c01ef78e21aa659e89cb369))
* **main:** release 0.3.50 ([#1379](https://github.com/tblakex01/k8sgpt/issues/1379)) ([d956f32](https://github.com/tblakex01/k8sgpt/commit/d956f32e1ed1fadd7c6c5dcca9182a8157e306a9))
* **main:** release 0.4.0 ([#1382](https://github.com/tblakex01/k8sgpt/issues/1382)) ([e14c3da](https://github.com/tblakex01/k8sgpt/commit/e14c3dad55b4c0ba05d8dc7fb7c0a0413a3b3263))
* **main:** release 0.4.1 ([#1389](https://github.com/tblakex01/k8sgpt/issues/1389)) ([5a48bae](https://github.com/tblakex01/k8sgpt/commit/5a48bae66794eb56d4fb04c7c25ca2a9727f9ab2))
* **main:** release 0.4.10 ([#1441](https://github.com/tblakex01/k8sgpt/issues/1441)) ([766b51c](https://github.com/tblakex01/k8sgpt/commit/766b51cd3e9448b90a5a63295dfa7fecbd9ea558))
* **main:** release 0.4.11 ([#1451](https://github.com/tblakex01/k8sgpt/issues/1451)) ([96d86d3](https://github.com/tblakex01/k8sgpt/commit/96d86d3eb0a8004fd8b4c2e9818e75fe8f2cb9d1))
* **main:** release 0.4.12 ([#1460](https://github.com/tblakex01/k8sgpt/issues/1460)) ([17863c2](https://github.com/tblakex01/k8sgpt/commit/17863c24d579fc91e49bbb61fb4c0571c1ec5357))
* **main:** release 0.4.13 ([#1465](https://github.com/tblakex01/k8sgpt/issues/1465)) ([67f5855](https://github.com/tblakex01/k8sgpt/commit/67f58556950480f9ff352a0a4e71d84c8f75b470))
* **main:** release 0.4.14 ([#1470](https://github.com/tblakex01/k8sgpt/issues/1470)) ([a56e663](https://github.com/tblakex01/k8sgpt/commit/a56e6631693e471d8739336bda089f4872a0f78a))
* **main:** release 0.4.15 ([#1477](https://github.com/tblakex01/k8sgpt/issues/1477)) ([f2f25ed](https://github.com/tblakex01/k8sgpt/commit/f2f25edef7d0693bd62b5b8f3e5f1cfbf747113d))
* **main:** release 0.4.16 ([#1478](https://github.com/tblakex01/k8sgpt/issues/1478)) ([34ff645](https://github.com/tblakex01/k8sgpt/commit/34ff645fa0964ff32b17e3d859f5aa8220c15867))
* **main:** release 0.4.17 ([#1499](https://github.com/tblakex01/k8sgpt/issues/1499)) ([306b3c9](https://github.com/tblakex01/k8sgpt/commit/306b3c9997e03592ad3eff735b72c066422d4e3a))
* **main:** release 0.4.18 ([#1510](https://github.com/tblakex01/k8sgpt/issues/1510)) ([47f09ac](https://github.com/tblakex01/k8sgpt/commit/47f09ac68656ab4ffeca4124249dd598d983618b))
* **main:** release 0.4.19 ([#1531](https://github.com/tblakex01/k8sgpt/issues/1531)) ([ff61948](https://github.com/tblakex01/k8sgpt/commit/ff619481cc2883ab341f2d98113def4e5926e61e))
* **main:** release 0.4.2 ([#1400](https://github.com/tblakex01/k8sgpt/issues/1400)) ([a75ec50](https://github.com/tblakex01/k8sgpt/commit/a75ec50789d200b2a18ce04743c58381fc6c6dbd))
* **main:** release 0.4.20 ([#1533](https://github.com/tblakex01/k8sgpt/issues/1533)) ([57d3272](https://github.com/tblakex01/k8sgpt/commit/57d32720dccda2257377fa758cfda77c96b08dd6))
* **main:** release 0.4.21 ([#1536](https://github.com/tblakex01/k8sgpt/issues/1536)) ([392c79d](https://github.com/tblakex01/k8sgpt/commit/392c79d0be50ce45dcdada7574b853574d14dc6f))
* **main:** release 0.4.22 ([#1545](https://github.com/tblakex01/k8sgpt/issues/1545)) ([fe46087](https://github.com/tblakex01/k8sgpt/commit/fe4608793de4118d72c2235d6e32859a5c7b50f8))
* **main:** release 0.4.23 ([#1549](https://github.com/tblakex01/k8sgpt/issues/1549)) ([00c99dc](https://github.com/tblakex01/k8sgpt/commit/00c99dc93490d6f382d315404a4da628e5d1d8b8))
* **main:** release 0.4.24 ([#1560](https://github.com/tblakex01/k8sgpt/issues/1560)) ([8bbffed](https://github.com/tblakex01/k8sgpt/commit/8bbffed643f04b803cf9030d10b1d05815c6d7f0))
* **main:** release 0.4.25 ([#1576](https://github.com/tblakex01/k8sgpt/issues/1576)) ([83c5d67](https://github.com/tblakex01/k8sgpt/commit/83c5d670842f9e7087863170d0c6ca8046d4cef6))
* **main:** release 0.4.26 ([#1584](https://github.com/tblakex01/k8sgpt/issues/1584)) ([ee6f584](https://github.com/tblakex01/k8sgpt/commit/ee6f58443b760a19b9a1d69c1742db743c1d214e))
* **main:** release 0.4.27 ([#1590](https://github.com/tblakex01/k8sgpt/issues/1590)) ([e7b7a5d](https://github.com/tblakex01/k8sgpt/commit/e7b7a5db47aaee418fbd2a4b9e5afeef6bebc0a4))
* **main:** release 0.4.28 ([#1591](https://github.com/tblakex01/k8sgpt/issues/1591)) ([1a8f1d4](https://github.com/tblakex01/k8sgpt/commit/1a8f1d47a44f88e6fc9eeba405c4f9a05c95f12f))
* **main:** release 0.4.29 ([#1614](https://github.com/tblakex01/k8sgpt/issues/1614)) ([285c135](https://github.com/tblakex01/k8sgpt/commit/285c1353d5d92b56e3eb74e030025af3bef44bab))
* **main:** release 0.4.3 ([#1412](https://github.com/tblakex01/k8sgpt/issues/1412)) ([d1a29e4](https://github.com/tblakex01/k8sgpt/commit/d1a29e400168053cb7357701995e30ffb8640efb))
* **main:** release 0.4.30 ([#1618](https://github.com/tblakex01/k8sgpt/issues/1618)) ([36de157](https://github.com/tblakex01/k8sgpt/commit/36de157e21907c8701614079841eec3530b4c383))
* **main:** release 0.4.4 ([#1421](https://github.com/tblakex01/k8sgpt/issues/1421)) ([e0d66f4](https://github.com/tblakex01/k8sgpt/commit/e0d66f43f794ef675784a03b4b2500e76d1c1844))
* **main:** release 0.4.5 ([#1424](https://github.com/tblakex01/k8sgpt/issues/1424)) ([9874cef](https://github.com/tblakex01/k8sgpt/commit/9874cef8bf9f44990c6718ce0fdc55b70ad88265))
* **main:** release 0.4.6 ([#1427](https://github.com/tblakex01/k8sgpt/issues/1427)) ([c1b267b](https://github.com/tblakex01/k8sgpt/commit/c1b267b81818acfba4a1499863eb49ed66ea6996))
* **main:** release 0.4.7 ([#1432](https://github.com/tblakex01/k8sgpt/issues/1432)) ([05040da](https://github.com/tblakex01/k8sgpt/commit/05040da188c85ae7ab83bccb222cdbf3410073b8))
* **main:** release 0.4.8 ([#1435](https://github.com/tblakex01/k8sgpt/issues/1435)) ([0c63044](https://github.com/tblakex01/k8sgpt/commit/0c630442541537c15e4590b5d14ca08f29b20a4c))
* **main:** release 0.4.9 ([#1439](https://github.com/tblakex01/k8sgpt/issues/1439)) ([e778348](https://github.com/tblakex01/k8sgpt/commit/e7783482cef7a08740c84ea100e86387eadac7fb))
* missing filter arg on serve ([#1583](https://github.com/tblakex01/k8sgpt/issues/1583)) ([f1d2e30](https://github.com/tblakex01/k8sgpt/commit/f1d2e306f32eb1e01a2788174084be29a7fa1282))
* model access ([#1529](https://github.com/tblakex01/k8sgpt/issues/1529)) ([be4fb1c](https://github.com/tblakex01/k8sgpt/commit/be4fb1cc034d9c3843cf3e9912a26e05bd54c146))
* model name ([#1535](https://github.com/tblakex01/k8sgpt/issues/1535)) ([0f700f0](https://github.com/tblakex01/k8sgpt/commit/0f700f0cd39bf5881d6c05240b842f4df7a6c016))
* remediating security issue ([#1381](https://github.com/tblakex01/k8sgpt/issues/1381)) ([1f95358](https://github.com/tblakex01/k8sgpt/commit/1f953585c91f8a208db3b37440e4d458b8d821eb))
* remove code cov ([#832](https://github.com/tblakex01/k8sgpt/issues/832)) ([a774265](https://github.com/tblakex01/k8sgpt/commit/a77426593d7f3a8cfa810336ff08a2266db7fb4f))
* removed krew release ([#1434](https://github.com/tblakex01/k8sgpt/issues/1434)) ([39ae2aa](https://github.com/tblakex01/k8sgpt/commit/39ae2aa6351d6a77e0b45ad15b0d10b86a33f3be))
* renovate.json ([#1290](https://github.com/tblakex01/k8sgpt/issues/1290)) ([458fcfe](https://github.com/tblakex01/k8sgpt/commit/458fcfe8d330523781d32af680febc2a0c0525a2))
* set correct license during package build ([#872](https://github.com/tblakex01/k8sgpt/issues/872)) ([42be51b](https://github.com/tblakex01/k8sgpt/commit/42be51bc8f625a35b1435c461d9a32c3c4905f1c))
* update brew installation note ([#1155](https://github.com/tblakex01/k8sgpt/issues/1155)) ([ab534d1](https://github.com/tblakex01/k8sgpt/commit/ab534d184fcd538f2ba10a6b5bf3a74c28d5fee6))
* update goreleaser ldflags ([#1154](https://github.com/tblakex01/k8sgpt/issues/1154)) ([aeae2ba](https://github.com/tblakex01/k8sgpt/commit/aeae2ba765c7db6e4953b5a93c54617f1dd85efa))
* update license file path to avoid conflicting installations ([#878](https://github.com/tblakex01/k8sgpt/issues/878)) ([#1073](https://github.com/tblakex01/k8sgpt/issues/1073)) ([85a76a3](https://github.com/tblakex01/k8sgpt/commit/85a76a3be06df0ff713192d1f08fd01d1e8f219b))
* update renovate config and bundle deps in groups ([#1026](https://github.com/tblakex01/k8sgpt/issues/1026)) ([bd2e06b](https://github.com/tblakex01/k8sgpt/commit/bd2e06bae72528c5af1b4f44674d624d474d40dc))
* updated actor for login ([#1430](https://github.com/tblakex01/k8sgpt/issues/1430)) ([b626102](https://github.com/tblakex01/k8sgpt/commit/b6261026f8b41e505359a52c18bebec7ef5079f9))
* updated deps ([#951](https://github.com/tblakex01/k8sgpt/issues/951)) ([015bccf](https://github.com/tblakex01/k8sgpt/commit/015bccfc2eae587e0ade371211404f5af4c37d27))
* updated goreleaser config ([#1149](https://github.com/tblakex01/k8sgpt/issues/1149)) ([c834c09](https://github.com/tblakex01/k8sgpt/commit/c834c099969f3e888f49f73fba6794387063a6fc))
* updated readme ([#1620](https://github.com/tblakex01/k8sgpt/issues/1620)) ([fd5bba6](https://github.com/tblakex01/k8sgpt/commit/fd5bba6ab3ad7a81ef982f1980ac9c9de23bc46c))
* updated the goreleaser action ([#1160](https://github.com/tblakex01/k8sgpt/issues/1160)) ([9bace02](https://github.com/tblakex01/k8sgpt/commit/9bace02a6702a8af0e6511b51ffc38378e14d3cb))
* updated to use CNCF runners ([#1305](https://github.com/tblakex01/k8sgpt/issues/1305)) ([5f01cc6](https://github.com/tblakex01/k8sgpt/commit/5f01cc685f61cb2181ed70b4ca523ad4a8280fc8))
* updating deps ([#1422](https://github.com/tblakex01/k8sgpt/issues/1422)) ([5b7fb7e](https://github.com/tblakex01/k8sgpt/commit/5b7fb7e6199635e109c1bf7355bc11ff6f60071b))
* util tests ([#1594](https://github.com/tblakex01/k8sgpt/issues/1594)) ([21369c5](https://github.com/tblakex01/k8sgpt/commit/21369c5c0917fd2b6ae4173378b2e257e2b1de7b))


### Docs

* add CLAUDE.md for Claude Code guidance ([aea4c3a](https://github.com/tblakex01/k8sgpt/commit/aea4c3a352b75b721787ccc04f83cfba6b7e96a0))
* add logAnalyzer in README.md ([#1081](https://github.com/tblakex01/k8sgpt/issues/1081)) ([5cfe332](https://github.com/tblakex01/k8sgpt/commit/5cfe3325cb556cfb9d0532ae26727441c5177015))
* add table of contents and cleanup ([#1413](https://github.com/tblakex01/k8sgpt/issues/1413)) ([a31d07c](https://github.com/tblakex01/k8sgpt/commit/a31d07c802694d3455b665382ff12a2abc3e0ef7))
* adjusted README information about providers ([#844](https://github.com/tblakex01/k8sgpt/issues/844)) ([745e960](https://github.com/tblakex01/k8sgpt/commit/745e960f492e6dd0e50aa4a1ce7239c677025024))
* align Go version with go.mod toolchain ([#1609](https://github.com/tblakex01/k8sgpt/issues/1609)) ([19a172e](https://github.com/tblakex01/k8sgpt/commit/19a172e575ffba6cd89330479033731426358342))
* fix broken schema link in README.md ([#1373](https://github.com/tblakex01/k8sgpt/issues/1373)) ([076ca2f](https://github.com/tblakex01/k8sgpt/commit/076ca2f14832cf83e43c465c377ef21825218b2f))
* fix the slack invite link ([#1450](https://github.com/tblakex01/k8sgpt/issues/1450)) ([9ce3346](https://github.com/tblakex01/k8sgpt/commit/9ce33469d85aa0829e995e4b404ae85734124fb4))
* remove extra dollar sign in README.md ([#1410](https://github.com/tblakex01/k8sgpt/issues/1410)) ([a962741](https://github.com/tblakex01/k8sgpt/commit/a962741220bf98e159f14895d01cd596a7691f87))
* update "CLI Installation" section in README.md ([#1126](https://github.com/tblakex01/k8sgpt/issues/1126)) ([#1127](https://github.com/tblakex01/k8sgpt/issues/1127)) ([b2b8682](https://github.com/tblakex01/k8sgpt/commit/b2b86826e55984c2b6aed6554869d7ce66a5f854))
* update README with DaemonSet, Secret analyzers and severity/remediation features ([fa89147](https://github.com/tblakex01/k8sgpt/commit/fa8914745d356d5847720aceae3c9c3811999573))


### Refactoring

* improve MCP server handlers with better error handling and pagination ([#1613](https://github.com/tblakex01/k8sgpt/issues/1613)) ([abc4647](https://github.com/tblakex01/k8sgpt/commit/abc46474e372bcd27201f1a64372c04269acee13))
* replace util.SliceContainsString with slices.Contains & make fmt ([#1041](https://github.com/tblakex01/k8sgpt/issues/1041)) ([1ae4e75](https://github.com/tblakex01/k8sgpt/commit/1ae4e751967850e8146f8f3fa04c0dd302ef15bf))
